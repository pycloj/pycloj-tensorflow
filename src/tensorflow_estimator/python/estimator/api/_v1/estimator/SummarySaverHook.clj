(ns tensorflow-estimator.python.estimator.api.-v1.estimator.SummarySaverHook
...
(defn SummarySaverHook 
  ...
  (py/call-attr estimator "SummarySaverHook"  save_steps save_secs output_dir summary_writer scaffold summary_op ))
