(ns tensorflow-estimator.python.estimator.api.-v1.estimator.LinearClassifier
...
(defn LinearClassifier 
  ...
  * for each `column` in `feature_columns`:
  ...
  @end_compatibility
  "
  [feature_columns model_dir & {:keys [n_classes weight_column label_vocabulary optimizer config partitioner warm_start_from loss_reduction sparse_combiner]
                       :or {weight_column None label_vocabulary None config None partitioner None warm_start_from None}} ]
    (py/call-attr-kw estimator "LinearClassifier" [feature_columns model_dir] {:n_classes n_classes :weight_column weight_column :label_vocabulary label_vocabulary :optimizer optimizer :config config :partitioner partitioner :warm_start_from warm_start_from :loss_reduction loss_reduction :sparse_combiner sparse_combiner }))
