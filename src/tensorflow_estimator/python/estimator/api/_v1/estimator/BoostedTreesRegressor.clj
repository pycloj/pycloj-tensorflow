(ns tensorflow-estimator.python.estimator.api.-v1.estimator.BoostedTreesRegressor
...
(defn BoostedTreesRegressor 
  ...
  @end_compatibility
  "
  [feature_columns n_batches_per_layer model_dir & {:keys [label_dimension weight_column n_trees max_depth learning_rate l1_regularization l2_regularization tree_complexity min_node_weight config center_bias pruning_mode quantile_sketch_epsilon train_in_memory]
                       :or {weight_column None config None}} ]
    (py/call-attr-kw estimator "BoostedTreesRegressor" [feature_columns n_batches_per_layer model_dir] {:label_dimension label_dimension :weight_column weight_column :n_trees n_trees :max_depth max_depth :learning_rate learning_rate :l1_regularization l1_regularization :l2_regularization l2_regularization :tree_complexity tree_complexity :min_node_weight min_node_weight :config config :center_bias center_bias :pruning_mode pruning_mode :quantile_sketch_epsilon quantile_sketch_epsilon :train_in_memory train_in_memory }))
