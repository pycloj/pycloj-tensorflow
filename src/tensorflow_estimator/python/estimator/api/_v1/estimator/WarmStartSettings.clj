(ns tensorflow-estimator.python.estimator.api.-v1.estimator.WarmStartSettings
...
(defn WarmStartSettings 
  ...
  [ckpt_to_initialize_from & {:keys [vars_to_warm_start var_name_to_vocab_info var_name_to_prev_var_name]
    ...
    (py/call-attr-kw estimator "WarmStartSettings" [ckpt_to_initialize_from] {:vars_to_warm_start vars_to_warm_start :var_name_to_vocab_info var_name_to_vocab_info :var_name_to_prev_var_name var_name_to_prev_var_name }))

(defn ckpt-to-initialize-from 
  "Alias for field number 0"
  [ self ]
    (py/call-attr self "ckpt_to_initialize_from"))

(defn var-name-to-prev-var-name 
  "Alias for field number 3"
  [ self ]
    (py/call-attr self "var_name_to_prev_var_name"))

(defn var-name-to-vocab-info 
  "Alias for field number 2"
  [ self ]
    (py/call-attr self "var_name_to_vocab_info"))

(defn vars-to-warm-start 
  "Alias for field number 1"
  [ self ]
    (py/call-attr self "vars_to_warm_start"))
