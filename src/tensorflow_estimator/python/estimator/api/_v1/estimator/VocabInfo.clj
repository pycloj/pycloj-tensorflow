(ns tensorflow-estimator.python.estimator.api.-v1.estimator.VocabInfo
...
```python
  ...
  [new_vocab new_vocab_size num_oov_buckets old_vocab & {:keys [old_vocab_size backup_initializer axis]
    ...
    (py/call-attr-kw estimator "VocabInfo" [new_vocab new_vocab_size num_oov_buckets old_vocab] {:old_vocab_size old_vocab_size :backup_initializer backup_initializer :axis axis }))
