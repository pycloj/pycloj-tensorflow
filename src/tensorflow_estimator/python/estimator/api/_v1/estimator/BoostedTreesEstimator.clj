(ns tensorflow-estimator.python.estimator.api.-v1.estimator.BoostedTreesEstimator
...
(defn BoostedTreesEstimator 
  "An Estimator for Tensorflow Boosted Trees models."
  [feature_columns n_batches_per_layer head model_dir weight_column & {:keys [n_trees max_depth learning_rate l1_regularization l2_regularization tree_complexity min_node_weight config center_bias pruning_mode quantile_sketch_epsilon]
                       :or {config None}} ]
    (py/call-attr-kw estimator "BoostedTreesEstimator" [feature_columns n_batches_per_layer head model_dir weight_column] {:n_trees n_trees :max_depth max_depth :learning_rate learning_rate :l1_regularization l1_regularization :l2_regularization l2_regularization :tree_complexity tree_complexity :min_node_weight min_node_weight :config config :center_bias center_bias :pruning_mode pruning_mode :quantile_sketch_epsilon quantile_sketch_epsilon }))
