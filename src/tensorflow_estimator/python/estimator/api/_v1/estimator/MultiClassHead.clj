(ns tensorflow-estimator.python.estimator.api.-v1.estimator.MultiClassHead
...
(defn MultiClassHead 
  ...
  [n_classes weight_column label_vocabulary & {:keys [loss_reduction loss_fn name]
    ...
    (py/call-attr-kw estimator "MultiClassHead" [n_classes weight_column label_vocabulary] {:loss_reduction loss_reduction :loss_fn loss_fn :name name }))
