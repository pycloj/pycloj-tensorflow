(ns tensorflow-estimator.python.estimator.api.-v1.estimator.LoggingTensorHook
...
(defn LoggingTensorHook 
  ...
  [tensors every_n_iter every_n_secs & {:keys [at_end formatter]
                       :or {formatter None}} ]
    (py/call-attr-kw estimator "LoggingTensorHook" [tensors every_n_iter every_n_secs] {:at_end at_end :formatter formatter }))
