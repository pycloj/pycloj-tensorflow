(ns tensorflow-estimator.python.estimator.api.-v1.estimator.StepCounterHook
...
(defn StepCounterHook 
  ...
  [ & {:keys [every_n_steps every_n_secs output_dir summary_writer]
   ...
   (py/call-attr-kw estimator "StepCounterHook" [] {:every_n_steps every_n_steps :every_n_secs every_n_secs :output_dir output_dir :summary_writer summary_writer }))
