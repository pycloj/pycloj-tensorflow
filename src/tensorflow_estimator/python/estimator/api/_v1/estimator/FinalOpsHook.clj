(ns tensorflow-estimator.python.estimator.api.-v1.estimator.FinalOpsHook
...
(defn FinalOpsHook 
  ...
  (py/call-attr estimator "FinalOpsHook"  final_ops final_ops_feed_dict ))
...
(defn final-ops-values 
  ""
  [ self ]
    (py/call-attr self "final_ops_values"))
