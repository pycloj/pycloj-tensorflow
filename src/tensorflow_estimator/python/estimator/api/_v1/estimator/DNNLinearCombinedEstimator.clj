(ns tensorflow-estimator.python.estimator.api.-v1.estimator.DNNLinearCombinedEstimator
...
(defn DNNLinearCombinedEstimator 
  ...
  * for each `column` in `dnn_feature_columns` + `linear_feature_columns`:
  ...
  @end_compatibility
  "
  [head model_dir linear_feature_columns & {:keys [linear_optimizer dnn_feature_columns dnn_optimizer dnn_hidden_units dnn_activation_fn dnn_dropout input_layer_partitioner config linear_sparse_combiner]
                       :or {dnn_feature_columns None dnn_hidden_units None dnn_dropout None input_layer_partitioner None config None}} ]
    (py/call-attr-kw estimator "DNNLinearCombinedEstimator" [head model_dir linear_feature_columns] {:linear_optimizer linear_optimizer :dnn_feature_columns dnn_feature_columns :dnn_optimizer dnn_optimizer :dnn_hidden_units dnn_hidden_units :dnn_activation_fn dnn_activation_fn :dnn_dropout dnn_dropout :input_layer_partitioner input_layer_partitioner :config config :linear_sparse_combiner linear_sparse_combiner }))
