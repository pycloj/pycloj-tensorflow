(ns tensorflow-estimator.python.estimator.api.-v1.estimator.NanTensorHook
...
(defn NanTensorHook 
  ...
  Can either fail with exception or just stop training.
  "
  [loss_tensor  & {:keys [fail_on_nan_loss]} ]
    (py/call-attr-kw estimator "NanTensorHook" [loss_tensor] {:fail_on_nan_loss fail_on_nan_loss }))
