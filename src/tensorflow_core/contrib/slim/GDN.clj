(ns tensorflow-core.contrib.slim.GDN
...
(defn GDN 
  ...
  [ & {:keys [inverse beta_min gamma_init reparam_offset data_format activity_regularizer trainable name]
   ...
   (py/call-attr-kw slim "GDN" [] {:inverse inverse :beta_min beta_min :gamma_init gamma_init :reparam_offset reparam_offset :data_format data_format :activity_regularizer activity_regularizer :trainable trainable :name name }))
