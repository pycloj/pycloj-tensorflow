(ns tensorflow-core.contrib.slim.RevBlock
...
(defn RevBlock 
  "Block of reversible layers. See rev_block."
  [f g & {:keys [num_layers f_side_input g_side_input use_efficient_backprop name]
                       :or {f_side_input None g_side_input None}} ]
    (py/call-attr-kw slim "RevBlock" [f g] {:num_layers num_layers :f_side_input f_side_input :g_side_input g_side_input :use_efficient_backprop use_efficient_backprop :name name }))
...
(defn backward 
  ""
  [ self y1 y2 ]
  (py/call-attr self "backward"  self y1 y2 ))
...
(defn call 
  ""
  [self inputs  & {:keys [forward]} ]
    (py/call-attr-kw self "call" [inputs] {:forward forward }))
