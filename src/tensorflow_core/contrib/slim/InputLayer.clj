(ns tensorflow-core.contrib.slim.InputLayer
...
(defn InputLayer 
  ...
  [feature_columns weight_collections & {:keys [trainable cols_to_vars name create_scope_now]
    ...
    (py/call-attr-kw slim "InputLayer" [feature_columns weight_collections] {:trainable trainable :cols_to_vars cols_to_vars :name name :create_scope_now create_scope_now }))
