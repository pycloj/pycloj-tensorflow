(ns tensorflow-core.contrib.lookup.MutableDenseHashTable
...
(defn MutableDenseHashTable 
  ...
  [key_dtype value_dtype default_value empty_key deleted_key initial_num_buckets  & {:keys [name checkpoint]} ]
    (py/call-attr-kw lookup "MutableDenseHashTable" [key_dtype value_dtype default_value empty_key deleted_key initial_num_buckets] {:name name :checkpoint checkpoint }))
