(ns tensorflow.python.keras.api.-v1.keras.metrics.MeanTensor
...
(defn MeanTensor 
  ...
  "
  [  ]
  (py/call-attr metrics "MeanTensor"  ))
...
(defn update-state 
  ...
  (py/call-attr self "update_state"  self values sample_weight ))
