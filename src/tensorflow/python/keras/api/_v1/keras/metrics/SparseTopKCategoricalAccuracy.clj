(ns tensorflow.python.keras.api.-v1.keras.metrics.SparseTopKCategoricalAccuracy
...
(defn SparseTopKCategoricalAccuracy 
  "Computes how often integer targets are in the top `K` predictions.
  ...
  "
  [  ]
  (py/call-attr metrics "SparseTopKCategoricalAccuracy"  ))
