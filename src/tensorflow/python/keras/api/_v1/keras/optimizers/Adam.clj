(ns tensorflow.python.keras.api.-v1.keras.optimizers.Adam
...
(defn Adam 
  ...
  Reddi et al., 5-8](https://openreview.net/pdf?id=ryQu7f-RZ).
  "
  [ & {:keys [learning_rate beta_1 beta_2 epsilon amsgrad name]} ]
   (py/call-attr-kw optimizers "Adam" [] {:learning_rate learning_rate :beta_1 beta_1 :beta_2 beta_2 :epsilon epsilon :amsgrad amsgrad :name name }))
(defn add-slot 
