(ns tensorflow.python.keras.api.-v1.keras.optimizers.Nadam
...
(defn Nadam 
  ...
  [ & {:keys [learning_rate beta_1 beta_2 epsilon name]} ]
   (py/call-attr-kw optimizers "Nadam" [] {:learning_rate learning_rate :beta_1 beta_1 :beta_2 beta_2 :epsilon epsilon :name name }))
(defn add-slot 
