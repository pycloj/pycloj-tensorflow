(ns tensorflow.python.keras.api.-v1.keras.optimizers.Ftrl
...
(defn Ftrl 
  ...
  replaced with gradient_with_shrinkage.
  "
  [ & {:keys [learning_rate learning_rate_power initial_accumulator_value l1_regularization_strength l2_regularization_strength name l2_shrinkage_regularization_strength]} ]
   (py/call-attr-kw optimizers "Ftrl" [] {:learning_rate learning_rate :learning_rate_power learning_rate_power :initial_accumulator_value initial_accumulator_value :l1_regularization_strength l1_regularization_strength :l2_regularization_strength l2_regularization_strength :name name :l2_shrinkage_regularization_strength l2_shrinkage_regularization_strength }))
(defn add-slot 
