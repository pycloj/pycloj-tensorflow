(ns tensorflow.python.keras.api.-v1.keras.initializers.RandomUniform
...
(defn RandomUniform 
  ...
  [ & {:keys [minval maxval seed dtype]
   ...
   (py/call-attr-kw initializers "RandomUniform" [] {:minval minval :maxval maxval :seed seed :dtype dtype }))
