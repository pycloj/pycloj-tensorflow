(ns tensorflow.python.keras.api.-v1.keras.initializers.TruncatedNormal
...
(defn TruncatedNormal 
  ...
  [ & {:keys [mean stddev seed dtype]
   ...
   (py/call-attr-kw initializers "TruncatedNormal" [] {:mean mean :stddev stddev :seed seed :dtype dtype }))
