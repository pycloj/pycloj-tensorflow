(ns tensorflow.python.keras.api.-v1.keras.preprocessing.text.Tokenizer
...
(defn Tokenizer 
  "Text tokenization utility class.
    ...
    `0` is a reserved index that won't be assigned to any word.
    "
  [num_words & {:keys [filters lower split char_level oov_token document_count]
                       :or {oov_token None}} ]
    (py/call-attr-kw text "Tokenizer" [num_words] {:filters filters :lower lower :split split :char_level char_level :oov_token oov_token :document_count document_count }))
