(ns tensorflow.python.keras.api.-v1.keras.experimental.SequenceFeatures
...
(defn SequenceFeatures 
  ...
  [feature_columns & {:keys [trainable name]
                       :or {name None}} ]
    (py/call-attr-kw experimental "SequenceFeatures" [feature_columns] {:trainable trainable :name name }))
...
(defn call 
  "Returns sequence input corresponding to the `feature_columns`.
    ...
    "
  [ self features ]
  (py/call-attr self "call"  self features ))
