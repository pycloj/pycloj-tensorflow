(ns tensorflow.python.keras.api.-v1.keras.experimental.PeepholeLSTMCell
...
(defn PeepholeLSTMCell 
  ...
  ```
  "
  [units & {:keys [activation recurrent_activation use_bias kernel_initializer recurrent_initializer bias_initializer unit_forget_bias kernel_regularizer recurrent_regularizer bias_regularizer kernel_constraint recurrent_constraint bias_constraint dropout recurrent_dropout implementation]
                       :or {kernel_regularizer None recurrent_regularizer None bias_regularizer None kernel_constraint None recurrent_constraint None bias_constraint None}} ]
    (py/call-attr-kw experimental "PeepholeLSTMCell" [units] {:activation activation :recurrent_activation recurrent_activation :use_bias use_bias :kernel_initializer kernel_initializer :recurrent_initializer recurrent_initializer :bias_initializer bias_initializer :unit_forget_bias unit_forget_bias :kernel_regularizer kernel_regularizer :recurrent_regularizer recurrent_regularizer :bias_regularizer bias_regularizer :kernel_constraint kernel_constraint :recurrent_constraint recurrent_constraint :bias_constraint bias_constraint :dropout dropout :recurrent_dropout recurrent_dropout :implementation implementation }))
...
(defn call 
  ""
  [ self inputs states training ]
  (py/call-attr self "call"  self inputs states training ))
...
(defn get-dropout-mask-for-cell 
  "Get the dropout mask for RNN cell's input.
    ...
    "
  [self inputs training  & {:keys [count]} ]
    (py/call-attr-kw self "get_dropout_mask_for_cell" [inputs training] {:count count }))

(defn get-initial-state 
  ""
  [ self inputs batch_size dtype ]
  (py/call-attr self "get_initial_state"  self inputs batch_size dtype ))
...
(defn get-recurrent-dropout-mask-for-cell 
  "Get the recurrent dropout mask for RNN cell.
    ...
    "
  [self inputs training  & {:keys [count]} ]
    (py/call-attr-kw self "get_recurrent_dropout_mask_for_cell" [inputs training] {:count count }))
...
(defn reset-dropout-mask 
  "Reset the cached dropout masks if any.
    ...
    "
  [ self  ]
  (py/call-attr self "reset_dropout_mask"  self  ))

(defn reset-recurrent-dropout-mask 
  "Reset the cached recurrent dropout masks if any.
    ...
    "
  [ self  ]
  (py/call-attr self "reset_recurrent_dropout_mask"  self  ))
