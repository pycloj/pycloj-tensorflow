(ns tensorflow.python.keras.api.-v1.keras.layers.StackedRNNCells
...
(defn StackedRNNCells 
  ...
  "
  [ cells ]
  (py/call-attr layers "StackedRNNCells"  cells ))
...
(defn call 
  ""
  [ self inputs states constants ]
  (py/call-attr self "call"  self inputs states constants ))
