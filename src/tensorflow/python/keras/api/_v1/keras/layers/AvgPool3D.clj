(ns tensorflow.python.keras.api.-v1.keras.layers.AvgPool3D
...
(defn AvgPool3D 
  ...
  [ & {:keys [pool_size strides padding data_format]
   ...
   (py/call-attr-kw layers "AvgPool3D" [] {:pool_size pool_size :strides strides :padding padding :data_format data_format }))
