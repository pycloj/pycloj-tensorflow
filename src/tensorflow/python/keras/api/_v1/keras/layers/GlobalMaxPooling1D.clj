(ns tensorflow.python.keras.api.-v1.keras.layers.GlobalMaxPooling1D
...
(defn GlobalMaxPooling1D 
  ...
  "
  [ & {:keys [data_format]} ]
   (py/call-attr-kw layers "GlobalMaxPooling1D" [] {:data_format data_format }))
