(ns tensorflow.python.keras.api.-v1.keras.layers.SimpleRNNCell
...
(defn SimpleRNNCell 
  ...
  Call arguments:
    ...
    training: Python boolean indicating whether the layer should behave in
      ...
      `recurrent_dropout` is used.
  "
  [units & {:keys [activation use_bias kernel_initializer recurrent_initializer bias_initializer kernel_regularizer recurrent_regularizer bias_regularizer kernel_constraint recurrent_constraint bias_constraint dropout recurrent_dropout]
