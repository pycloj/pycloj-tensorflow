(ns tensorflow.python.keras.api.-v1.keras.layers.LSTM
...
(defn LSTM 
  ...
  Call arguments:
    ...
    initial_state: List of initial state tensors to be passed to the first
      call of the cell.
  "
  [units & {:keys [activation recurrent_activation use_bias kernel_initializer recurrent_initializer bias_initializer unit_forget_bias kernel_regularizer recurrent_regularizer bias_regularizer activity_regularizer kernel_constraint recurrent_constraint bias_constraint dropout recurrent_dropout implementation return_sequences return_state go_backwards stateful unroll]
