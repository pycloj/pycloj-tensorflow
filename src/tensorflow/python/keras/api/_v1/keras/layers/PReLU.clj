(ns tensorflow.python.keras.api.-v1.keras.layers.PReLU
...
(defn PReLU 
  ...
  [ & {:keys [alpha_initializer alpha_regularizer alpha_constraint shared_axes]
       :or {alpha_regularizer None alpha_constraint None shared_axes None}} ]
  
   (py/call-attr-kw layers "PReLU" [] {:alpha_initializer alpha_initializer :alpha_regularizer alpha_regularizer :alpha_constraint alpha_constraint :shared_axes shared_axes }))
