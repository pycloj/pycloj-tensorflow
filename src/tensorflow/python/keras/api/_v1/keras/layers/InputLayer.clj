(ns tensorflow.python.keras.api.-v1.keras.layers.InputLayer
...
(defn InputLayer 
  ...
  Arguments:
      ...
      name: Name of the layer (string).
  "
  [input_shape batch_size dtype input_tensor & {:keys [sparse name ragged]
                       :or {name None}} ]
    (py/call-attr-kw layers "InputLayer" [input_shape batch_size dtype input_tensor] {:sparse sparse :name name :ragged ragged }))
