(ns tensorflow.python.keras.api.-v1.keras.layers.Lambda
...
(defn Lambda 
  ...
  Output shape: Specified by `output_shape` argument
  "
  [ function output_shape mask arguments ]
  (py/call-attr layers "Lambda"  function output_shape mask arguments ))
...
(defn call 
  ""
  [ self inputs mask training ]
  (py/call-attr self "call"  self inputs mask training ))
