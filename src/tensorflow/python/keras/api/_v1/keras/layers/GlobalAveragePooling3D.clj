(ns tensorflow.python.keras.api.-v1.keras.layers.GlobalAveragePooling3D
...
(defn GlobalAveragePooling3D 
  ...
  "
  [ data_format ]
  (py/call-attr layers "GlobalAveragePooling3D"  data_format ))
