(ns tensorflow.python.keras.api.-v1.keras.layers.GRUCell
...
(defn GRUCell 
  ...
  Call arguments:
    ...
    training: Python boolean indicating whether the layer should behave in
      ...
      `recurrent_dropout` is used.
  "
  [units & {:keys [activation recurrent_activation use_bias kernel_initializer recurrent_initializer bias_initializer kernel_regularizer recurrent_regularizer bias_regularizer kernel_constraint recurrent_constraint bias_constraint dropout recurrent_dropout implementation reset_after]
    ...
    (py/call-attr-kw layers "GRUCell" [units] {:activation activation :recurrent_activation recurrent_activation :use_bias use_bias :kernel_initializer kernel_initializer :recurrent_initializer recurrent_initializer :bias_initializer bias_initializer :kernel_regularizer kernel_regularizer :recurrent_regularizer recurrent_regularizer :bias_regularizer bias_regularizer :kernel_constraint kernel_constraint :recurrent_constraint recurrent_constraint :bias_constraint bias_constraint :dropout dropout :recurrent_dropout recurrent_dropout :implementation implementation :reset_after reset_after }))
