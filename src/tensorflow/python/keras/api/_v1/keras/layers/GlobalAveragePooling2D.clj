(ns tensorflow.python.keras.api.-v1.keras.layers.GlobalAveragePooling2D
...
(defn GlobalAveragePooling2D 
  ...
  "
  [ data_format ]
  (py/call-attr layers "GlobalAveragePooling2D"  data_format ))
