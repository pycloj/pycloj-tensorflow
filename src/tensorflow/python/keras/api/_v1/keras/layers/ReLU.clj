(ns tensorflow.python.keras.api.-v1.keras.layers.ReLU
...
(defn ReLU 
  ...
  Arguments:
    ...
    threshold: Float. Threshold value for thresholded activation.
  "
  [max_value  & {:keys [negative_slope threshold]} ]
    (py/call-attr-kw layers "ReLU" [max_value] {:negative_slope negative_slope :threshold threshold }))
