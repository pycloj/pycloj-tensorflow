(ns tensorflow.python.keras.api.-v1.keras.layers.AveragePooling3D
...
(defn AveragePooling3D 
  ...
  [ & {:keys [pool_size strides padding data_format]
       :or {strides None data_format None}} ]
  
   (py/call-attr-kw layers "AveragePooling3D" [] {:pool_size pool_size :strides strides :padding padding :data_format data_format }))
