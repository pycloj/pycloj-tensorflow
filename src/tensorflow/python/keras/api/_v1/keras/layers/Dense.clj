(ns tensorflow.python.keras.api.-v1.keras.layers.Dense
...
(defn Dense 
  ...
  Output shape:
    ...
    the output would have shape `(batch_size, units)`.
  "
  [units activation & {:keys [use_bias kernel_initializer bias_initializer kernel_regularizer bias_regularizer activity_regularizer kernel_constraint bias_constraint]
                       :or {kernel_regularizer None bias_regularizer None activity_regularizer None kernel_constraint None bias_constraint None}} ]
