(ns tensorflow.python.keras.api.-v1.keras.layers.LayerNormalization
...
(defn LayerNormalization 
  ...
  References:
    - [Layer Normalization](https://arxiv.org/abs/1607.06450)
  "
  [ & {:keys [axis epsilon center scale beta_initializer gamma_initializer beta_regularizer gamma_regularizer beta_constraint gamma_constraint trainable name]
       :or {beta_regularizer None gamma_regularizer None beta_constraint None gamma_constraint None name None}} ]
  
   (py/call-attr-kw layers "LayerNormalization" [] {:axis axis :epsilon epsilon :center center :scale scale :beta_initializer beta_initializer :gamma_initializer gamma_initializer :beta_regularizer beta_regularizer :gamma_regularizer gamma_regularizer :beta_constraint beta_constraint :gamma_constraint gamma_constraint :trainable trainable :name name }))
