(ns tensorflow.python.keras.api.-v1.keras.layers.AvgPool1D
...
(defn AvgPool1D 
  ...
  [ & {:keys [pool_size strides padding data_format]
   ...
   (py/call-attr-kw layers "AvgPool1D" [] {:pool_size pool_size :strides strides :padding padding :data_format data_format }))
