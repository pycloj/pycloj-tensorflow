(ns tensorflow.python.keras.api.-v1.keras.layers.DepthwiseConv2D
...
(defn DepthwiseConv2D 
  ...
  Output shape:
    ...
    `rows` and `cols` values might have changed due to padding.
  "
  [kernel_size & {:keys [strides padding depth_multiplier data_format activation use_bias depthwise_initializer bias_initializer depthwise_regularizer bias_regularizer activity_regularizer depthwise_constraint bias_constraint]
                       :or {data_format None activation None depthwise_regularizer None bias_regularizer None activity_regularizer None depthwise_constraint None bias_constraint None}} ]
