(ns tensorflow.python.keras.api.-v1.keras.layers.DenseFeatures
...
(defn DenseFeatures 
  ...
  ```
  "
  [feature_columns & {:keys [trainable name]
                       :or {name None}} ]
    (py/call-attr-kw layers "DenseFeatures" [feature_columns] {:trainable trainable :name name }))
...
(defn call 
  "Returns a dense tensor corresponding to the `feature_columns`.
    ...
    "
  [ self features cols_to_output_tensors ]
  (py/call-attr self "call"  self features cols_to_output_tensors ))
