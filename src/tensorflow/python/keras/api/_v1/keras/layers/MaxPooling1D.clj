(ns tensorflow.python.keras.api.-v1.keras.layers.MaxPooling1D
...
(defn MaxPooling1D 
  ...
  [ & {:keys [pool_size strides padding data_format]
   ...
   (py/call-attr-kw layers "MaxPooling1D" [] {:pool_size pool_size :strides strides :padding padding :data_format data_format }))
