(ns tensorflow.python.keras.api.-v1.keras.layers.ActivityRegularization
...
(defn ActivityRegularization 
  ...
  "
  [ & {:keys [l1 l2]} ]
   (py/call-attr-kw layers "ActivityRegularization" [] {:l1 l1 :l2 l2 }))
