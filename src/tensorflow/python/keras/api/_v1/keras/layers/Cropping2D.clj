(ns tensorflow.python.keras.api.-v1.keras.layers.Cropping2D
...
(defn Cropping2D 
  ...
  ```
  "
  [ & {:keys [cropping data_format]
       :or {data_format None}} ]
  
   (py/call-attr-kw layers "Cropping2D" [] {:cropping cropping :data_format data_format }))
