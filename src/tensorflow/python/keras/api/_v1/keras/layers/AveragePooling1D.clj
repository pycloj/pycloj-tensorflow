(ns tensorflow.python.keras.api.-v1.keras.layers.AveragePooling1D
...
(defn AveragePooling1D 
  ...
  [ & {:keys [pool_size strides padding data_format]
   ...
   (py/call-attr-kw layers "AveragePooling1D" [] {:pool_size pool_size :strides strides :padding padding :data_format data_format }))
