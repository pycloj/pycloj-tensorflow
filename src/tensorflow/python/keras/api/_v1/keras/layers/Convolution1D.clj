(ns tensorflow.python.keras.api.-v1.keras.layers.Convolution1D
...
(defn Convolution1D 
  ...
  [filters kernel_size & {:keys [strides padding data_format dilation_rate activation use_bias kernel_initializer bias_initializer kernel_regularizer bias_regularizer activity_regularizer kernel_constraint bias_constraint]
                       :or {activation None kernel_regularizer None bias_regularizer None activity_regularizer None kernel_constraint None bias_constraint None}} ]
    (py/call-attr-kw layers "Convolution1D" [filters kernel_size] {:strides strides :padding padding :data_format data_format :dilation_rate dilation_rate :activation activation :use_bias use_bias :kernel_initializer kernel_initializer :bias_initializer bias_initializer :kernel_regularizer kernel_regularizer :bias_regularizer bias_regularizer :activity_regularizer activity_regularizer :kernel_constraint kernel_constraint :bias_constraint bias_constraint }))
