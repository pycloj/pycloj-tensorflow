(ns tensorflow.python.keras.api.-v1.keras.layers.GlobalAveragePooling1D
...
(defn GlobalAveragePooling1D 
  ...
  "
  [ & {:keys [data_format]} ]
   (py/call-attr-kw layers "GlobalAveragePooling1D" [] {:data_format data_format }))
...
(defn call 
  ""
  [ self inputs mask ]
  (py/call-attr self "call"  self inputs mask ))
