(ns tensorflow.python.keras.api.-v1.keras.layers.Bidirectional
...
(defn Bidirectional 
  ...
  ```
  "
  [layer & {:keys [merge_mode weights backward_layer]
                       :or {weights None backward_layer None}} ]
    (py/call-attr-kw layers "Bidirectional" [layer] {:merge_mode merge_mode :weights weights :backward_layer backward_layer }))
...
(defn call 
  ...
  [ self inputs training mask initial_state constants ]
  (py/call-attr self "call"  self inputs training mask initial_state constants ))
