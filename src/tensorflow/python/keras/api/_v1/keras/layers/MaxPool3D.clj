(ns tensorflow.python.keras.api.-v1.keras.layers.MaxPool3D
...
(defn MaxPool3D 
  ...
  [ & {:keys [pool_size strides padding data_format]
   ...
   (py/call-attr-kw layers "MaxPool3D" [] {:pool_size pool_size :strides strides :padding padding :data_format data_format }))
