(ns tensorflow.python.keras.api.-v1.keras.layers.ZeroPadding2D
...
(defn ZeroPadding2D 
  ...
  Output shape:
    ...
    - If `data_format` is `\"channels_first\"`:
        `(batch, channels, padded_rows, padded_cols)`
  "
  [ & {:keys [padding data_format]
       :or {data_format None}} ]
  
   (py/call-attr-kw layers "ZeroPadding2D" [] {:padding padding :data_format data_format }))
