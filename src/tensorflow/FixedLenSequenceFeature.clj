(ns tensorflow.FixedLenSequenceFeature
...
(defn FixedLenSequenceFeature 
  ...
  [shape dtype & {:keys [allow_missing default_value]
    ...
    (py/call-attr-kw tensorflow "FixedLenSequenceFeature" [shape dtype] {:allow_missing allow_missing :default_value default_value }))
