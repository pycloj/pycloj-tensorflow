...
(defn VariableScope 
  ...
  [reuse & {:keys [name initializer regularizer caching_device partitioner custom_getter name_scope dtype use_resource constraint]
    ...
    (py/call-attr-kw tensorflow "VariableScope" [reuse] {:name name :initializer initializer :regularizer regularizer :caching_device caching_device :partitioner partitioner :custom_getter custom_getter :name_scope name_scope :dtype dtype :use_resource use_resource :constraint constraint }))
