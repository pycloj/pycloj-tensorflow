(ns tensorflow.linalg.LinearOperatorCirculant3D
...
(defn LinearOperatorCirculant3D 
  "`LinearOperator` acting like a nested block circulant matrix.
  ...
  * If `is_X == None` (the default), callers should have no expectation either
  ...
  [spectrum & {:keys [input_output_dtype is_non_singular is_self_adjoint is_positive_definite is_square name]
    ...
    (py/call-attr-kw linalg "LinearOperatorCirculant3D" [spectrum] {:input_output_dtype input_output_dtype :is_non_singular is_non_singular :is_self_adjoint is_self_adjoint :is_positive_definite is_positive_definite :is_square is_square :name name }))
