(ns tensorflow.linalg.LinearOperatorBlockDiag
...
(defn LinearOperatorBlockDiag 
  ...
  * If `is_X == None` (the default), callers should have no expectation either
    way.
  "
  [operators is_non_singular is_self_adjoint is_positive_definite & {:keys [is_square name]
                       :or {name None}} ]
    (py/call-attr-kw linalg "LinearOperatorBlockDiag" [operators is_non_singular is_self_adjoint is_positive_definite] {:is_square is_square :name name }))
