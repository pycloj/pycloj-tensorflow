(ns tensorflow.linalg.LinearOperatorKronecker
...
(defn LinearOperatorKronecker 
  ...
  * If `is_X == None` (the default), callers should have no expectation either
  ...
  (py/call-attr linalg "LinearOperatorKronecker"  operators is_non_singular is_self_adjoint is_positive_definite is_square name ))
