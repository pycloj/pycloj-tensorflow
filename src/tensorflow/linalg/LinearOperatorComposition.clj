(ns tensorflow.linalg.LinearOperatorComposition
...
(defn LinearOperatorComposition 
  "Composes one or more `LinearOperators`.
  ...
  * If `is_X == None` (the default), callers should have no expectation either
    way.
  "
  [ operators is_non_singular is_self_adjoint is_positive_definite is_square name ]
  (py/call-attr linalg "LinearOperatorComposition"  operators is_non_singular is_self_adjoint is_positive_definite is_square name ))
