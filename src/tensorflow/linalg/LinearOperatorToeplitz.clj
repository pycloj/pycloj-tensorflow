(ns tensorflow.linalg.LinearOperatorToeplitz
...
(defn LinearOperatorToeplitz 
  ...
  * If `is_X == None` (the default), callers should have no expectation either
    way.
  "
  [col row is_non_singular is_self_adjoint is_positive_definite is_square  & {:keys [name]} ]
    (py/call-attr-kw linalg "LinearOperatorToeplitz" [col row is_non_singular is_self_adjoint is_positive_definite is_square] {:name name }))
