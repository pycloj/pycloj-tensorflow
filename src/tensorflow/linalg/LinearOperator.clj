(ns tensorflow.linalg.LinearOperator
...
(defn LinearOperator 
  ...
  * If `is_X == None` (the default), callers should have no expectation either
    way.
  "
  [ dtype graph_parents is_non_singular is_self_adjoint is_positive_definite is_square name ]
  (py/call-attr linalg "LinearOperator"  dtype graph_parents is_non_singular is_self_adjoint is_positive_definite is_square name ))
