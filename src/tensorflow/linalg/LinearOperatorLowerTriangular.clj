(ns tensorflow.linalg.LinearOperatorLowerTriangular
...
(defn LinearOperatorLowerTriangular 
  "`LinearOperator` acting like a [batch] square lower triangular matrix.
  ...
  * If `is_X == None` (the default), callers should have no expectation either
    way.
  "
  [tril is_non_singular is_self_adjoint is_positive_definite is_square  & {:keys [name]} ]
    (py/call-attr-kw linalg "LinearOperatorLowerTriangular" [tril is_non_singular is_self_adjoint is_positive_definite is_square] {:name name }))
