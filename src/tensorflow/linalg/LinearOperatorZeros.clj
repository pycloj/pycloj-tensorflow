(ns tensorflow.linalg.LinearOperatorZeros
...
(defn LinearOperatorZeros 
  ...
  * If `is_X == None` (the default), callers should have no expectation either
    way.
  "
  [num_rows num_columns batch_shape dtype  & {:keys [is_non_singular is_self_adjoint is_positive_definite is_square assert_proper_shapes name]} ]
    (py/call-attr-kw linalg "LinearOperatorZeros" [num_rows num_columns batch_shape dtype] {:is_non_singular is_non_singular :is_self_adjoint is_self_adjoint :is_positive_definite is_positive_definite :is_square is_square :assert_proper_shapes assert_proper_shapes :name name }))
...
(defn add-to-tensor 
  "Add matrix represented by this operator to `mat`.  Equiv to `I + mat`.
    ...
    "
  [self mat  & {:keys [name]} ]
    (py/call-attr-kw self "add_to_tensor" [mat] {:name name }))
(defn adjoint 
  "Returns the adjoint of the current `LinearOperator`.
