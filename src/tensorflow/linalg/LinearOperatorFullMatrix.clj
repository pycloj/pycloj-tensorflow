(ns tensorflow.linalg.LinearOperatorFullMatrix
...
(defn LinearOperatorFullMatrix 
  ...
  * If `is_X == None` (the default), callers should have no expectation either
    way.
  "
  [matrix is_non_singular is_self_adjoint is_positive_definite is_square  & {:keys [name]} ]
    (py/call-attr-kw linalg "LinearOperatorFullMatrix" [matrix is_non_singular is_self_adjoint is_positive_definite is_square] {:name name }))
