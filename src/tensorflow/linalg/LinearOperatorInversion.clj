(ns tensorflow.linalg.LinearOperatorInversion
...
(defn LinearOperatorInversion 
  ...
  * If `is_X == None` (the default), callers should have no expectation either
    way.
  "
  [ operator is_non_singular is_self_adjoint is_positive_definite is_square name ]
  (py/call-attr linalg "LinearOperatorInversion"  operator is_non_singular is_self_adjoint is_positive_definite is_square name ))
