(ns tensorflow.-api.v1.compat.v1.sparse
...
(py/initialize!)
(defonce sparse (import-module "tensorflow._api.v1.compat.v1.sparse"))
...
Raises:
  ...
  (py/call-attr sparse "add"  a b threshold thresh ))
...
Raises:
  ...
  [axis sp_inputs name & {:keys [expand_nonconcat_dim concat_dim expand_nonconcat_dims]
    ...
    (py/call-attr-kw sparse "concat" [axis sp_inputs name] {:expand_nonconcat_dim expand_nonconcat_dim :concat_dim concat_dim :expand_nonconcat_dims expand_nonconcat_dims }))
...
(defn cross 
  ...
  "
  [ inputs name ]
  (py/call-attr sparse "cross"  inputs name ))
...
(defn cross-hashed 
  ...
  "
  [inputs & {:keys [num_buckets hash_key name]
                       :or {hash_key None name None}} ]
    (py/call-attr-kw sparse "cross_hashed" [inputs] {:num_buckets num_buckets :hash_key hash_key :name name }))
...
(defn expand-dims 
  ...
  "
  [ sp_input axis name ]
  (py/call-attr sparse "expand_dims"  sp_input axis name ))
...
(defn eye 
  ...
  Returns:
    ...
    diagonal.
  "
  [num_rows num_columns & {:keys [dtype name]
                       :or {name None}} ]
    (py/call-attr-kw sparse "eye" [num_rows num_columns] {:dtype dtype :name name }))

(defn fill-empty-rows 
  ...
  (py/call-attr sparse "fill_empty_rows"  sp_input default_value name ))
...
(defn from-dense 
  ...
  "
  [ tensor name ]
  (py/call-attr sparse "from_dense"  tensor name ))
...
(defn mask 
  ...
  "
  [ a mask_indices name ]
  (py/call-attr sparse "mask"  a mask_indices name ))
...
(defn matmul 
  ...
  * Is the density of `A` larger than approximately 15%?
  ...
  [sp_a b & {:keys [adjoint_a adjoint_b name]
                       :or {name None}} ]
    (py/call-attr-kw sparse "matmul" [sp_a b] {:adjoint_a adjoint_a :adjoint_b adjoint_b :name name }))
...
(defn maximum 
  ...
  "
  [ sp_a sp_b name ]
  (py/call-attr sparse "maximum"  sp_a sp_b name ))
(defn merge 
...
Raises:
  ...
  [sp_ids sp_values vocab_size name  & {:keys [already_sorted]} ]
    (py/call-attr-kw sparse "merge" [sp_ids sp_values vocab_size name] {:already_sorted already_sorted }))
...
(defn minimum 
  ...
  "
  [ sp_a sp_b name ]
  (py/call-attr sparse "minimum"  sp_a sp_b name ))
...
(defn placeholder 
  ...
  **Important**: This sparse tensor will produce an error if evaluated.
  ...
  "
  [ dtype shape name ]
  (py/call-attr sparse "placeholder"  dtype shape name ))
...
Returns:
  ...
  (py/call-attr sparse "reduce_max"  sp_input axis keepdims reduction_axes keep_dims ))

(defn reduce-max-sparse 
...
Returns:
  ...
  [ sp_input axis keepdims reduction_axes keep_dims ]
  (py/call-attr sparse "reduce_max_sparse"  sp_input axis keepdims reduction_axes keep_dims ))
...
Returns:
  The reduced Tensor."
  [ sp_input axis keepdims reduction_axes keep_dims ]
  (py/call-attr sparse "reduce_sum"  sp_input axis keepdims reduction_axes keep_dims ))

(defn reduce-sum-sparse 
...
Returns:
  The reduced SparseTensor."
  [ sp_input axis keepdims reduction_axes keep_dims ]
  (py/call-attr sparse "reduce_sum_sparse"  sp_input axis keepdims reduction_axes keep_dims ))
...
(defn reorder 
  ...
  "
  [ sp_input name ]
  (py/call-attr sparse "reorder"  sp_input name ))
...
(defn reset-shape 
  ...
  "
  [ sp_input new_shape ]
  (py/call-attr sparse "reset_shape"  sp_input new_shape ))
...
(defn reshape 
  ...
  "
  [ sp_input shape name ]
  (py/call-attr sparse "reshape"  sp_input shape name ))
...
(defn retain 
  ...
  "
  [ sp_input to_retain ]
  (py/call-attr sparse "retain"  sp_input to_retain ))
...
(defn segment-mean 
  ...
  (py/call-attr sparse "segment_mean"  data indices segment_ids name num_segments ))
...
(defn segment-sqrt-n 
  ...
  "
  [ data indices segment_ids name num_segments ]
  (py/call-attr sparse "segment_sqrt_n"  data indices segment_ids name num_segments ))
...
(defn segment-sum 
  ...
  "
  [ data indices segment_ids name num_segments ]
  (py/call-attr sparse "segment_sum"  data indices segment_ids name num_segments ))
...
(defn slice 
  ...
  (py/call-attr sparse "slice"  sp_input start size name ))
...
(defn softmax 
  ...
  "
  [ sp_input name ]
  (py/call-attr sparse "softmax"  sp_input name ))

(defn sparse-dense-matmul 
  "Multiply SparseTensor (of rank 2) \"A\" by dense matrix \"B\".
  ...
  * Is the density of `A` larger than approximately 15%?
  ...
  [sp_a b & {:keys [adjoint_a adjoint_b name]
                       :or {name None}} ]
    (py/call-attr-kw sparse "sparse_dense_matmul" [sp_a b] {:adjoint_a adjoint_a :adjoint_b adjoint_b :name name }))
...
Raises:
  ...
  [ & {:keys [keyword_required sp_input num_split axis name split_dim]
   ...
   (py/call-attr-kw sparse "split" [] {:keyword_required keyword_required :sp_input sp_input :num_split num_split :axis axis :name name :split_dim split_dim }))
...
(defn to-dense 
  ...
  [sp_input default_value & {:keys [validate_indices name]
                       :or {name None}} ]
    (py/call-attr-kw sparse "to_dense" [sp_input default_value] {:validate_indices validate_indices :name name }))
...
(defn to-indicator 
  ...
  (py/call-attr sparse "to_indicator"  sp_input vocab_size name ))
...
(defn transpose 
  ...
  "
  [ sp_input perm name ]
  (py/call-attr sparse "transpose"  sp_input perm name ))
