(ns tensorflow.-api.v1.compat.v1.random
...
(py/initialize!)
(defonce random (import-module "tensorflow._api.v1.compat.v1.random"))
...
(defn get-seed 
  ...
  "
  [ op_seed ]
  (py/call-attr random "get_seed"  op_seed ))
...
Returns:
  ...
  (py/call-attr random "multinomial"  logits num_samples seed name output_dtype ))
...
(defn poisson 
  ...
  [lam shape & {:keys [dtype seed name]
                       :or {seed None name None}} ]
    (py/call-attr-kw random "poisson" [lam shape] {:dtype dtype :seed seed :name name }))
...
(defn set-random-seed 
  ...
  "
  [ seed ]
  (py/call-attr random "set_random_seed"  seed ))
...
Returns:
  ...
  [logits num_samples seed & {:keys [output_dtype name]
                       :or {name None}} ]
    (py/call-attr-kw random "stateless_multinomial" [logits num_samples seed] {:output_dtype output_dtype :name name }))
