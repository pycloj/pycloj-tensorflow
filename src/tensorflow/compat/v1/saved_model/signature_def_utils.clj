(ns tensorflow.-api.v1.compat.v1.saved-model.signature-def-utils
...
(py/initialize!)
(defonce signature-def-utils (import-module "tensorflow._api.v1.compat.v1.saved_model.signature_def_utils"))
