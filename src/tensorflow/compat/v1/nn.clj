(ns tensorflow.-api.v1.compat.v1.nn
...
(py/initialize!)
(defonce nn (import-module "tensorflow._api.v1.compat.v1.nn"))
...
(defn avg-pool 
  ...
  "
  [value ksize strides padding & {:keys [data_format name input]
                       :or {name None input None}} ]
    (py/call-attr-kw nn "avg_pool" [value ksize strides padding] {:data_format data_format :name name :input input }))
...
(defn avg-pool2d 
  ...
  [value ksize strides padding & {:keys [data_format name input]
                       :or {name None input None}} ]
    (py/call-attr-kw nn "avg_pool2d" [value ksize strides padding] {:data_format data_format :name name :input input }))
...
(defn avg-pool-v2 
  ...
  (py/call-attr nn "avg_pool_v2"  input ksize strides padding data_format name ))
...
(defn batch-norm-with-global-normalization 
  ...
  "
  [ t m v beta gamma variance_epsilon scale_after_normalization name input mean variance ]
  (py/call-attr nn "batch_norm_with_global_normalization"  t m v beta gamma variance_epsilon scale_after_normalization name input mean variance ))
...
(defn bidirectional-dynamic-rnn 
...
Raises:
  ...
  [cell_fw cell_bw inputs sequence_length initial_state_fw initial_state_bw dtype parallel_iterations & {:keys [swap_memory time_major scope]
                       :or {scope None}} ]
    (py/call-attr-kw nn "bidirectional_dynamic_rnn" [cell_fw cell_bw inputs sequence_length initial_state_fw initial_state_bw dtype parallel_iterations] {:swap_memory swap_memory :time_major time_major :scope scope }))
...
Raises:
  ...
  [ value filters stride padding use_cudnn_on_gpu data_format name input dilations ]
  (py/call-attr nn "conv1d"  value filters stride padding use_cudnn_on_gpu data_format name input dilations ))
...
(defn conv2d 
  ...
  Returns:
    A `Tensor`. Has the same type as `input`.
  "
  [input filter strides padding & {:keys [use_cudnn_on_gpu data_format dilations name filters]
                       :or {name None filters None}} ]
    (py/call-attr-kw nn "conv2d" [input filter strides padding] {:use_cudnn_on_gpu use_cudnn_on_gpu :data_format data_format :dilations dilations :name name :filters filters }))
...
(defn conv2d-backprop-filter 
  ...
  Returns:
    A `Tensor`. Has the same type as `input`.
  "
  [input filter_sizes out_backprop strides padding & {:keys [use_cudnn_on_gpu data_format dilations name]
                       :or {name None}} ]
    (py/call-attr-kw nn "conv2d_backprop_filter" [input filter_sizes out_backprop strides padding] {:use_cudnn_on_gpu use_cudnn_on_gpu :data_format data_format :dilations dilations :name name }))
...
(defn conv2d-backprop-input 
  ...
  "
  [input_sizes filter out_backprop strides padding & {:keys [use_cudnn_on_gpu data_format dilations name filters]
                       :or {name None filters None}} ]
    (py/call-attr-kw nn "conv2d_backprop_input" [input_sizes filter out_backprop strides padding] {:use_cudnn_on_gpu use_cudnn_on_gpu :data_format data_format :dilations dilations :name name :filters filters }))
...
(defn conv2d-transpose 
  ...
  Raises:
    ValueError: If input/output depth does not match `filter`'s shape, or if
      padding is other than `'VALID'` or `'SAME'`.
  "
  [value filter output_shape strides & {:keys [padding data_format name input filters dilations]
                       :or {name None input None filters None dilations None}} ]
    (py/call-attr-kw nn "conv2d_transpose" [value filter output_shape strides] {:padding padding :data_format data_format :name name :input input :filters filters :dilations dilations }))
...
(defn conv3d 
  ...
  Returns:
    A `Tensor`. Has the same type as `input`.
  "
  [input filter strides padding & {:keys [data_format dilations name filters]
                       :or {name None filters None}} ]
    (py/call-attr-kw nn "conv3d" [input filter strides padding] {:data_format data_format :dilations dilations :name name :filters filters }))
...
(defn conv3d-backprop-filter 
  ...
  [input filter_sizes out_backprop strides padding & {:keys [data_format dilations name]
                       :or {name None}} ]
    (py/call-attr-kw nn "conv3d_backprop_filter" [input filter_sizes out_backprop strides padding] {:data_format data_format :dilations dilations :name name }))
...
(defn conv3d-backprop-filter-v2 
  ...
  [input filter_sizes out_backprop strides padding & {:keys [data_format dilations name]
                       :or {name None}} ]
    (py/call-attr-kw nn "conv3d_backprop_filter_v2" [input filter_sizes out_backprop strides padding] {:data_format data_format :dilations dilations :name name }))
...
(defn conv3d-transpose 
  ...
  [value filter output_shape strides & {:keys [padding data_format name input filters dilations]
                       :or {name None input None filters None dilations None}} ]
    (py/call-attr-kw nn "conv3d_transpose" [value filter output_shape strides] {:padding padding :data_format data_format :name name :input input :filters filters :dilations dilations }))
...
(defn convolution 
  ...
  "
  [ input filter padding strides dilation_rate name data_format filters dilations ]
  (py/call-attr nn "convolution"  input filter padding strides dilation_rate name data_format filters dilations ))
(defn crelu 
  ...
  "
  [features name  & {:keys [axis]} ]
    (py/call-attr-kw nn "crelu" [features name] {:axis axis }))
(defn ctc-beam-search-decoder 
  ...
  **Note** The `ctc_greedy_decoder` is a special case of the
  ...
  "
  [inputs sequence_length  & {:keys [beam_width top_paths merge_repeated]} ]
    (py/call-attr-kw nn "ctc_beam_search_decoder" [inputs sequence_length] {:beam_width beam_width :top_paths top_paths :merge_repeated merge_repeated }))
(defn ctc-beam-search-decoder-v2 
  "Performs beam search decoding on the logits given in input.
  ...
  **Note** The `ctc_greedy_decoder` is a special case of the
  ...
  [inputs sequence_length  & {:keys [beam_width top_paths]} ]
    (py/call-attr-kw nn "ctc_beam_search_decoder_v2" [inputs sequence_length] {:beam_width beam_width :top_paths top_paths }))
...
(defn ctc-loss 
  ...
  * `preprocess_collapse_repeated=True`, `ctc_merge_repeated=True`
  ...
  "
  [labels inputs sequence_length & {:keys [preprocess_collapse_repeated ctc_merge_repeated ignore_longer_outputs_than_inputs time_major logits]
                       :or {logits None}} ]
    (py/call-attr-kw nn "ctc_loss" [labels inputs sequence_length] {:preprocess_collapse_repeated preprocess_collapse_repeated :ctc_merge_repeated ctc_merge_repeated :ignore_longer_outputs_than_inputs ignore_longer_outputs_than_inputs :time_major time_major :logits logits }))
...
(defn ctc-loss-v2 
  ...
  [labels logits label_length logit_length & {:keys [logits_time_major unique blank_index name]
    ...
    (py/call-attr-kw nn "ctc_loss_v2" [labels logits label_length logit_length] {:logits_time_major logits_time_major :unique unique :blank_index blank_index :name name }))
...
(defn depth-to-space 
  ...
  [input block_size name  & {:keys [data_format]} ]
    (py/call-attr-kw nn "depth_to_space" [input block_size name] {:data_format data_format }))
...
(defn depthwise-conv2d 
  ...
  "
  [ input filter strides padding rate name data_format dilations ]
  (py/call-attr nn "depthwise_conv2d"  input filter strides padding rate name data_format dilations ))
...
(defn depthwise-conv2d-native 
  ...
  [input filter strides padding & {:keys [data_format dilations name]
                       :or {name None}} ]
    (py/call-attr-kw nn "depthwise_conv2d_native" [input filter strides padding] {:data_format data_format :dilations dilations :name name }))
...
(defn depthwise-conv2d-native-backprop-filter 
  ...
  [input filter_sizes out_backprop strides padding & {:keys [data_format dilations name]
                       :or {name None}} ]
    (py/call-attr-kw nn "depthwise_conv2d_native_backprop_filter" [input filter_sizes out_backprop strides padding] {:data_format data_format :dilations dilations :name name }))
...
(defn depthwise-conv2d-native-backprop-input 
  ...
  [input_sizes filter out_backprop strides padding & {:keys [data_format dilations name]
                       :or {name None}} ]
    (py/call-attr-kw nn "depthwise_conv2d_native_backprop_input" [input_sizes filter out_backprop strides padding] {:data_format data_format :dilations dilations :name name }))
...
(defn dilation2d 
  ...
  Returns:
    A `Tensor`. Has the same type as `input`.
  "
  [ input filter strides rates padding name filters dilations ]
  (py/call-attr nn "dilation2d"  input filter strides rates padding name filters dilations ))
...
Raises:
  ValueError: If `rate` is not in `[0, 1)` or if `x` is not a floating
    point tensor."
  [ x keep_prob noise_shape seed name rate ]
  (py/call-attr nn "dropout"  x keep_prob noise_shape seed name rate ))
...
Raises:
  ...
  [cell inputs sequence_length initial_state dtype parallel_iterations & {:keys [swap_memory time_major scope]
                       :or {scope None}} ]
    (py/call-attr-kw nn "dynamic_rnn" [cell inputs sequence_length initial_state dtype parallel_iterations] {:swap_memory swap_memory :time_major time_major :scope scope }))
...
(defn embedding-lookup 
  ...
  "
  [params ids & {:keys [partition_strategy name validate_indices max_norm]
                       :or {name None max_norm None}} ]
    (py/call-attr-kw nn "embedding_lookup" [params ids] {:partition_strategy partition_strategy :name name :validate_indices validate_indices :max_norm max_norm }))
...
(defn embedding-lookup-sparse 
  ...
  [params sp_ids sp_weights & {:keys [partition_strategy name combiner max_norm]
    ...
    (py/call-attr-kw nn "embedding_lookup_sparse" [params sp_ids sp_weights] {:partition_strategy partition_strategy :name name :combiner combiner :max_norm max_norm }))
...
(defn erosion2d 
  ...
  Raises:
    ValueError: If the `value` depth does not match `kernel`' shape, or if
      padding is other than `'VALID'` or `'SAME'`.
  "
  [ value kernel strides rates padding name ]
  (py/call-attr nn "erosion2d"  value kernel strides rates padding name ))
...
`col_pooling_sequence`).
  ...
  [value pooling_ratio & {:keys [pseudo_random overlapping deterministic seed seed2 name]
                       :or {name None}} ]
    (py/call-attr-kw nn "fractional_avg_pool" [value pooling_ratio] {:pseudo_random pseudo_random :overlapping overlapping :deterministic deterministic :seed seed :seed2 seed2 :name name }))
...
`col_pooling_sequence`).
  ...
  [value pooling_ratio & {:keys [pseudo_random overlapping deterministic seed seed2 name]
                       :or {name None}} ]
    (py/call-attr-kw nn "fractional_max_pool" [value pooling_ratio] {:pseudo_random pseudo_random :overlapping overlapping :deterministic deterministic :seed seed :seed2 seed2 :name name }))

(defn fused-batch-norm 
  "Batch normalization.
  ...
  [x scale offset mean variance & {:keys [epsilon data_format is_training name]
                       :or {name None}} ]
    (py/call-attr-kw nn "fused_batch_norm" [x scale offset mean variance] {:epsilon epsilon :data_format data_format :is_training is_training :name name }))
...
(defn in-top-k 
  ...
  (py/call-attr nn "in_top_k"  predictions targets k name ))
...
Returns:
  ...
  [x axis & {:keys [epsilon name dim]
    ...
    (py/call-attr-kw nn "l2_normalize" [x axis] {:epsilon epsilon :name name :dim dim }))
...
Raises:
  ...
  (py/call-attr nn "log_softmax"  logits axis name dim ))
...
(defn log-uniform-candidate-sampler 
  ...
  "
  [ true_classes num_true num_sampled unique range_max seed name ]
  (py/call-attr nn "log_uniform_candidate_sampler"  true_classes num_true num_sampled unique range_max seed name ))
...
(defn max-pool 
  ...
  [value ksize strides padding & {:keys [data_format name input]
                       :or {name None input None}} ]
    (py/call-attr-kw nn "max_pool" [value ksize strides padding] {:data_format data_format :name name :input input }))
...
(defn max-pool-v2 
  ...
  "
  [ input ksize strides padding data_format name ]
  (py/call-attr nn "max_pool_v2"  input ksize strides padding data_format name ))
...
(defn max-pool-with-argmax 
  ...
  "
  [input ksize strides padding & {:keys [data_format Targmax name output_dtype include_batch_in_index]
                       :or {Targmax None name None output_dtype None}} ]
    (py/call-attr-kw nn "max_pool_with_argmax" [input ksize strides padding] {:data_format data_format :Targmax Targmax :name name :output_dtype output_dtype :include_batch_in_index include_batch_in_index }))
...
(defn moments 
  ...
  "
  [ x axes shift name keep_dims keepdims ]
  (py/call-attr nn "moments"  x axes shift name keep_dims keepdims ))
...
(defn nce-loss 
  ...
  "
  [weights biases labels inputs num_sampled num_classes & {:keys [num_true sampled_values remove_accidental_hits partition_strategy name]
                       :or {sampled_values None}} ]
    (py/call-attr-kw nn "nce_loss" [weights biases labels inputs num_sampled num_classes] {:num_true num_true :sampled_values sampled_values :remove_accidental_hits remove_accidental_hits :partition_strategy partition_strategy :name name }))
...
(defn pool 
  ...
  "
  [ input window_shape pooling_type padding dilation_rate strides name data_format dilations ]
  (py/call-attr nn "pool"  input window_shape pooling_type padding dilation_rate strides name data_format dilations ))
...
(defn quantized-avg-pool 
  ...
  (py/call-attr nn "quantized_avg_pool"  input min_input max_input ksize strides padding name ))
...
(defn quantized-conv2d 
  ...
  [input filter min_input max_input min_filter max_filter strides padding & {:keys [out_type dilations name]
                       :or {name None}} ]
    (py/call-attr-kw nn "quantized_conv2d" [input filter min_input max_input min_filter max_filter strides padding] {:out_type out_type :dilations dilations :name name }))
...
(defn quantized-max-pool 
  ...
  "
  [ input min_input max_input ksize strides padding name ]
  (py/call-attr nn "quantized_max_pool"  input min_input max_input ksize strides padding name ))
...
(defn quantized-relu-x 
  ...
  [features max_value min_features max_features & {:keys [out_type name]
                       :or {name None}} ]
    (py/call-attr-kw nn "quantized_relu_x" [features max_value min_features max_features] {:out_type out_type :name name }))
  ...
  **NOTE: This method is still in testing, and the API may change.**
  ...
  Raises:
    TypeError: If `cell` is not an instance of RNNCell, or `loop_fn` is not
      a `callable`.
  "
  [cell loop_fn parallel_iterations & {:keys [swap_memory scope]
                       :or {scope None}} ]
    (py/call-attr-kw nn "raw_rnn" [cell loop_fn parallel_iterations] {:swap_memory swap_memory :scope scope }))
...
(defn relu-layer 
  ...
  "
  [ x weights biases name ]
  (py/call-attr nn "relu_layer"  x weights biases name ))
...
(defn safe-embedding-lookup-sparse 
  ...
  "
  [embedding_weights sparse_ids sparse_weights & {:keys [combiner default_id name partition_strategy max_norm]
                       :or {default_id None name None max_norm None}} ]
    (py/call-attr-kw nn "safe_embedding_lookup_sparse" [embedding_weights sparse_ids sparse_weights] {:combiner combiner :default_id default_id :name name :partition_strategy partition_strategy :max_norm max_norm }))
...
(defn sampled-softmax-loss 
  ...
  "
  [weights biases labels inputs num_sampled num_classes & {:keys [num_true sampled_values remove_accidental_hits partition_strategy name seed]
                       :or {sampled_values None seed None}} ]
    (py/call-attr-kw nn "sampled_softmax_loss" [weights biases labels inputs num_sampled num_classes] {:num_true num_true :sampled_values sampled_values :remove_accidental_hits remove_accidental_hits :partition_strategy partition_strategy :name name :seed seed }))
...
(defn separable-conv2d 
  ...
  "
  [ input depthwise_filter pointwise_filter strides padding rate name data_format dilations ]
  (py/call-attr nn "separable_conv2d"  input depthwise_filter pointwise_filter strides padding rate name data_format dilations ))
...
(defn sigmoid-cross-entropy-with-logits 
  ...
  "
  [ _sentinel labels logits name ]
  (py/call-attr nn "sigmoid_cross_entropy_with_logits"  _sentinel labels logits name ))
...
Raises:
  InvalidArgumentError: if `logits` is empty or `axis` is beyond the last
    dimension of `logits`."
  [ logits axis name dim ]
  (py/call-attr nn "softmax"  logits axis name dim ))
...
Returns:
  ...
  [_sentinel labels logits & {:keys [dim name axis]
                       :or {name None axis None}} ]
    (py/call-attr-kw nn "softmax_cross_entropy_with_logits" [_sentinel labels logits] {:dim dim :name name :axis axis }))

(defn softmax-cross-entropy-with-logits-v2 
...
Returns:
  ...
  same as `logits` and its shape is the same as `labels` except that it does
  not have the last dimension of `labels`."
  [ labels logits axis name dim ]
  (py/call-attr nn "softmax_cross_entropy_with_logits_v2"  labels logits axis name dim ))
...
(defn space-to-batch 
  ...
  (py/call-attr nn "space_to_batch"  input paddings block_size name block_shape ))
(defn space-to-depth 
  ...
  "
  [input block_size name  & {:keys [data_format]} ]
    (py/call-attr-kw nn "space_to_depth" [input block_size name] {:data_format data_format }))
...
(defn sparse-softmax-cross-entropy-with-logits 
  ...
  **Note that to avoid confusion, it is required to pass only named arguments to
  ...
  "
  [ _sentinel labels logits name ]
  (py/call-attr nn "sparse_softmax_cross_entropy_with_logits"  _sentinel labels logits name ))
...
Raises:
  ...
  (py/call-attr nn "static_bidirectional_rnn"  cell_fw cell_bw inputs initial_state_fw initial_state_bw dtype sequence_length scope ))
...
Raises:
  ...
  (py/call-attr nn "static_rnn"  cell inputs initial_state dtype sequence_length scope ))
...
Raises:
  ...
  (py/call-attr nn "static_state_saving_rnn"  cell inputs state_saver state_name sequence_length scope ))
...
(defn sufficient-statistics 
  ...
  "
  [ x axes shift keep_dims name keepdims ]
  (py/call-attr nn "sufficient_statistics"  x axes shift keep_dims name keepdims ))
...
(defn uniform-candidate-sampler 
  ...
  "
  [ true_classes num_true num_sampled unique range_max seed name ]
  (py/call-attr nn "uniform_candidate_sampler"  true_classes num_true num_sampled unique range_max seed name ))
...
Raises:
  ValueError: If `logits` and `labels` do not have the same shape."
  [ labels logits pos_weight name targets ]
  (py/call-attr nn "weighted_cross_entropy_with_logits"  labels logits pos_weight name targets ))
...
(defn weighted-moments 
  ...
  "
  [ x axes frequency_weights name keep_dims keepdims ]
  (py/call-attr nn "weighted_moments"  x axes frequency_weights name keep_dims keepdims ))
...
(defn xw-plus-b 
  ...
  "
  [ x weights biases name ]
  (py/call-attr nn "xw_plus_b"  x weights biases name ))
