(ns tensorflow.-api.v1.compat.v2.feature-column
...
(py/initialize!)
(defonce feature-column (import-module "tensorflow._api.v1.compat.v2.feature_column"))
...
(defn categorical-column-with-vocabulary-file 
  ...
  Raises:
    ...
    ValueError: `dtype` is neither string nor integer.
  "
  [key vocabulary_file vocabulary_size & {:keys [dtype default_value num_oov_buckets]
                       :or {default_value None}} ]
    (py/call-attr-kw feature-column "categorical_column_with_vocabulary_file" [key vocabulary_file vocabulary_size] {:dtype dtype :default_value default_value :num_oov_buckets num_oov_buckets }))
...
(defn shared-embeddings 
  ...
  [categorical_columns dimension & {:keys [combiner initializer shared_embedding_collection_name ckpt_to_load_from tensor_name_in_ckpt max_norm trainable]
    ...
    (py/call-attr-kw feature-column "shared_embeddings" [categorical_columns dimension] {:combiner combiner :initializer initializer :shared_embedding_collection_name shared_embedding_collection_name :ckpt_to_load_from ckpt_to_load_from :tensor_name_in_ckpt tensor_name_in_ckpt :max_norm max_norm :trainable trainable }))
