(ns tensorflow.-api.v1.compat.v2.strings
...
(py/initialize!)
(defonce strings (import-module "tensorflow._api.v1.compat.v2.strings"))
...
(defn length 
  ...
  [input & {:keys [unit name]
                       :or {name None}} ]
    (py/call-attr-kw strings "length" [input] {:unit unit :name name }))
...
(defn reduce-join 
  ""
  [inputs axis & {:keys [keepdims separator name]
                       :or {name None}} ]
    (py/call-attr-kw strings "reduce_join" [inputs axis] {:keepdims keepdims :separator separator :name name }))
...
(defn split 
  ...
  [input sep & {:keys [maxsplit name]
                       :or {name None}} ]
    (py/call-attr-kw strings "split" [input sep] {:maxsplit maxsplit :name name }))
...
(defn substr 
  ...
  *NOTE*: `Substr` supports broadcasting up to two dimensions. More about
  ...
  [input pos len & {:keys [unit name]
                       :or {name None}} ]
    (py/call-attr-kw strings "substr" [input pos len] {:unit unit :name name }))
...
(defn to-hash-bucket 
  ...
  (py/call-attr strings "to_hash_bucket"  input num_buckets name ))
...
(defn to-number 
  ...
  [input & {:keys [out_type name]
                       :or {name None}} ]
    (py/call-attr-kw strings "to_number" [input] {:out_type out_type :name name }))
