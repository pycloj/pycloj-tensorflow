...
Returns:
  ...
  [ & {:keys [start step dtype]} ]
   (py/call-attr-kw data "Counter" [] {:start start :step step :dtype dtype }))

(defn assert-element-shape 
  ...
  "
  [ expected_shapes ]
  (py/call-attr data "assert_element_shape"  expected_shapes ))

(defn batch-and-drop-remainder 
...
Returns:
  ...
  `tf.data.Dataset.apply`"
  [ batch_size ]
  (py/call-attr data "batch_and_drop_remainder"  batch_size ))
...
Raises:
  ...
  [element_length_func bucket_boundaries bucket_batch_sizes padded_shapes padding_values  & {:keys [pad_to_bucket_boundary no_padding]} ]
    (py/call-attr-kw data "bucket_by_sequence_length" [element_length_func bucket_boundaries bucket_batch_sizes padded_shapes padding_values] {:pad_to_bucket_boundary pad_to_bucket_boundary :no_padding no_padding }))
...
Raises:
  ...
  (py/call-attr data "choose_from_datasets"  datasets choice_dataset ))
(defn copy-to-device 
...
Returns:
  ...
  [target_device  & {:keys [source_device]} ]
    (py/call-attr-kw data "copy_to_device" [target_device] {:source_device source_device }))
...
Returns:
  ...
  (py/call-attr data "dense_to_sparse_batch"  batch_size row_shape ))
...
Returns:
  ...
  `tf.data.Dataset.apply`."
  [ & {:keys [start]} ]
   (py/call-attr-kw data "enumerate_dataset" [] {:start start }))
...
(defn get-next-as-optional 
  ...
  "
  [ iterator ]
  (py/call-attr data "get_next_as_optional"  iterator ))
...
Raises:
  ...
  InvalidArgumentError (at runtime): if `dataset` does not contain exactly
    one element."
  [ dataset ]
  (py/call-attr data "get_single_element"  dataset ))
...
Returns:
  ...
  `tf.data.Dataset.apply`."
  [ key_func reducer ]
  (py/call-attr data "group_by_reducer"  key_func reducer ))
...
Raises:
  ...
  (py/call-attr data "group_by_window"  key_func reduce_func window_size window_size_func ))
...
Returns:
  ...
  `tf.data.Dataset.apply`."
  [  ]
  (py/call-attr data "ignore_errors"  ))
...
Raises:
  ...
  [file_pattern batch_size column_names column_defaults label_name select_columns & {:keys [field_delim use_quote_delim na_value header num_epochs shuffle shuffle_buffer_size shuffle_seed prefetch_buffer_size num_parallel_reads sloppy num_rows_for_inference compression_type]
...
state of an unsupported iterator will throw an error."
  [ iterator ]
  (py/call-attr data "make_saveable_from_iterator"  iterator ))
...
Raises:
  ...
  [map_func batch_size num_parallel_batches & {:keys [drop_remainder num_parallel_calls]
    ...
    (py/call-attr-kw data "map_and_batch" [map_func batch_size num_parallel_batches] {:drop_remainder drop_remainder :num_parallel_calls num_parallel_calls }))

(defn padded-batch-and-drop-remainder 
...
Returns:
  A `Dataset` transformation function, which can be passed to
  `tf.data.Dataset.apply`"
  [ batch_size padded_shapes padding_values ]
  (py/call-attr data "padded_batch_and_drop_remainder"  batch_size padded_shapes padding_values ))
...
Returns:
  ...
  [map_func cycle_length & {:keys [block_length sloppy buffer_output_elements prefetch_input_elements]
    ...
    (py/call-attr-kw data "parallel_interleave" [map_func cycle_length] {:block_length block_length :sloppy sloppy :buffer_output_elements buffer_output_elements :prefetch_input_elements prefetch_input_elements }))
...
Raises:
  ...
  [features  & {:keys [num_parallel_calls]} ]
    (py/call-attr-kw data "parse_example_dataset" [features] {:num_parallel_calls num_parallel_calls }))
...
Returns:
  ...
  `tf.data.Dataset.apply`."
  [ device buffer_size ]
  (py/call-attr data "prefetch_to_device"  device buffer_size ))
...
Returns:
  ...
  [file_pattern batch_size features & {:keys [reader reader_args randomize_input num_epochs capacity]
                       :or {reader_args None num_epochs None}} ]
    (py/call-attr-kw data "read_batch_features" [file_pattern batch_size features] {:reader reader :reader_args reader_args :randomize_input randomize_input :num_epochs num_epochs :capacity capacity }))
...
Raises:
  TypeError: if `dataset` is not a `tf.data.Dataset` object."
  [ dataset reducer ]
  (py/call-attr data "reduce_dataset"  dataset reducer ))
...
Returns:
  ...
  (py/call-attr data "rejection_resample"  class_func target_dist initial_dist seed ))
...
Raises:
  ...
  (py/call-attr data "sample_from_datasets"  datasets weights seed ))
...
Returns:
  ...
  (py/call-attr data "scan"  initial_state scan_func ))
...
Returns:
  ...
  (py/call-attr data "shuffle_and_repeat"  buffer_size count seed ))
(defn sliding-window-batch 
...
Raises:
  ...
  [window_size stride window_shift  & {:keys [window_stride]} ]
    (py/call-attr-kw data "sliding_window_batch" [window_size stride window_shift] {:window_stride window_stride }))
(defn sloppy-interleave 
...
Returns:
  A `Dataset` transformation function, which can be passed to
  `tf.data.Dataset.apply`."
  [map_func cycle_length  & {:keys [block_length]} ]
    (py/call-attr-kw data "sloppy_interleave" [map_func cycle_length] {:block_length block_length }))
