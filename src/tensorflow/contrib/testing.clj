...
(py/initialize!)
(defonce testing (import-module "tensorflow.contrib.testing"))
...
(defn assert-summary 
  ...
  (py/call-attr testing "assert_summary"  expected_tags expected_simple_values summary_proto ))
...
(defn latest-event-file 
  ...
  "
  [ base_dir ]
  (py/call-attr testing "latest_event_file"  base_dir ))
...
(defn latest-events 
  ...
  "
  [ base_dir ]
  (py/call-attr testing "latest_events"  base_dir ))
...
(defn latest-summaries 
  ...
  "
  [ base_dir ]
  (py/call-attr testing "latest_summaries"  base_dir ))
...
(defn simple-values-from-events 
  ...
  "
  [ events tags ]
  (py/call-attr testing "simple_values_from_events"  events tags ))
...
(defn to-summary-proto 
  ...
  "
  [ summary_str ]
  (py/call-attr testing "to_summary_proto"  summary_str ))
