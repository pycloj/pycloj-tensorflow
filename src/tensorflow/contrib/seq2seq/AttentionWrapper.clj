(ns tensorflow.contrib.seq2seq.AttentionWrapper
...
(defn AttentionWrapper 
  "Wraps another `RNNCell` with attention."
  [cell attention_mechanism attention_layer_size & {:keys [alignment_history cell_input_fn output_attention initial_cell_state name attention_layer attention_fn dtype]
                       :or {cell_input_fn None initial_cell_state None name None attention_layer None attention_fn None dtype None}} ]
    (py/call-attr-kw seq2seq "AttentionWrapper" [cell attention_mechanism attention_layer_size] {:alignment_history alignment_history :cell_input_fn cell_input_fn :output_attention output_attention :initial_cell_state initial_cell_state :name name :attention_layer attention_layer :attention_fn attention_fn :dtype dtype }))
