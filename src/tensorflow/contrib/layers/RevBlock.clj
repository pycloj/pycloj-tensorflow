(ns tensorflow.contrib.layers.RevBlock
...
(defn RevBlock 
  ...
  [f g & {:keys [num_layers f_side_input g_side_input use_efficient_backprop name]
    ...
    (py/call-attr-kw layers "RevBlock" [f g] {:num_layers num_layers :f_side_input f_side_input :g_side_input g_side_input :use_efficient_backprop use_efficient_backprop :name name }))
