(ns tensorflow.contrib.optimizer-v2.optimizer-v2-symbols.RMSPropOptimizer
...
(defn RMSPropOptimizer 
  ...
  (http://www.cs.toronto.edu/~tijmen/csc321/slides/lecture_slides_lec6.pdf).
  "
  [learning_rate  & {:keys [decay momentum epsilon use_locking centered name]} ]
    (py/call-attr-kw optimizer-v2 "RMSPropOptimizer" [learning_rate] {:decay decay :momentum momentum :epsilon epsilon :use_locking use_locking :centered centered :name name }))
