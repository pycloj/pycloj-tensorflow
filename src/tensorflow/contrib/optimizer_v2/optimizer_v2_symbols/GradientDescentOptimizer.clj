(ns tensorflow.contrib.optimizer-v2.optimizer-v2-symbols.GradientDescentOptimizer
...
(defn GradientDescentOptimizer 
  ...
  [learning_rate  & {:keys [use_locking name]} ]
    (py/call-attr-kw optimizer-v2 "GradientDescentOptimizer" [learning_rate] {:use_locking use_locking :name name }))
