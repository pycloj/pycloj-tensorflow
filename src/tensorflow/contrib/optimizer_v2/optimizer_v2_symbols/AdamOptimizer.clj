(ns tensorflow.contrib.optimizer-v2.optimizer-v2-symbols.AdamOptimizer
...
(defn AdamOptimizer 
  ...
  ([pdf](http://arxiv.org/pdf/1412.6980.pdf)).
  "
  [ & {:keys [learning_rate beta1 beta2 epsilon use_locking name]} ]
   (py/call-attr-kw optimizer-v2 "AdamOptimizer" [] {:learning_rate learning_rate :beta1 beta1 :beta2 beta2 :epsilon epsilon :use_locking use_locking :name name }))
