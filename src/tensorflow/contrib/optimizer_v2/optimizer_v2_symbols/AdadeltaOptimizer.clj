(ns tensorflow.contrib.optimizer-v2.optimizer-v2-symbols.AdadeltaOptimizer
...
(defn AdadeltaOptimizer 
  "Optimizer that implements the Adadelta algorithm.

  See [M. D. Zeiler](http://arxiv.org/abs/1212.5701)
  ([pdf](http://arxiv.org/pdf/1212.5701v1.pdf))
  "
  [ & {:keys [learning_rate rho epsilon use_locking name]} ]
   (py/call-attr-kw optimizer-v2 "AdadeltaOptimizer" [] {:learning_rate learning_rate :rho rho :epsilon epsilon :use_locking use_locking :name name }))
