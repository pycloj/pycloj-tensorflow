(ns tensorflow.contrib.optimizer-v2.optimizer-v2-symbols.MomentumOptimizer
...
(defn MomentumOptimizer 
  ...
  when that part of the variable was used in the forward pass.
  "
  [learning_rate momentum  & {:keys [use_locking name use_nesterov]} ]
    (py/call-attr-kw optimizer-v2 "MomentumOptimizer" [learning_rate momentum] {:use_locking use_locking :name name :use_nesterov use_nesterov }))
