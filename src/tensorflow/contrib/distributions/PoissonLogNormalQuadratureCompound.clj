(ns tensorflow.contrib.distributions.PoissonLogNormalQuadratureCompound
...
(defn PoissonLogNormalQuadratureCompound 
  "`PoissonLogNormalQuadratureCompound` distribution.
  ...
  pln = tfd.PoissonLogNormalQuadratureCompound(
      ...
      validate_args=True)
  "
  [loc scale  & {:keys [quadrature_size quadrature_fn validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "PoissonLogNormalQuadratureCompound" [loc scale] {:quadrature_size quadrature_size :quadrature_fn quadrature_fn :validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
...
(defn quadrature-size 
  ""
  [ self ]
    (py/call-attr self "quadrature_size"))
(defn quantile 
