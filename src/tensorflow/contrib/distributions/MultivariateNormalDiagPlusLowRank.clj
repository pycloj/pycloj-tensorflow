(ns tensorflow.contrib.distributions.MultivariateNormalDiagPlusLowRank
...
(defn MultivariateNormalDiagPlusLowRank 
  "The multivariate normal distribution on `R^k`.
  ...
  * `scale_perturb_diag.shape = [r]`.
  ...
  "
  [loc scale_diag scale_identity_multiplier scale_perturb_factor scale_perturb_diag  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "MultivariateNormalDiagPlusLowRank" [loc scale_diag scale_identity_multiplier scale_perturb_factor scale_perturb_diag] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
