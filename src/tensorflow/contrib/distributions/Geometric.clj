(ns tensorflow.contrib.distributions.Geometric
...
(defn Geometric 
  ...
  * `k` is a non-negative integer.
  ...
  "
  [logits probs  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "Geometric" [logits probs] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
