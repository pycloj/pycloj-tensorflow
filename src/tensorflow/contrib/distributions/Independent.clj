(ns tensorflow.contrib.distributions.Independent
...
(defn Independent 
  ...
  "
  [distribution reinterpreted_batch_ndims & {:keys [validate_args name]
                       :or {name None}} ]
    (py/call-attr-kw distributions "Independent" [distribution reinterpreted_batch_ndims] {:validate_args validate_args :name name }))
...
(defn reinterpreted-batch-ndims 
  ""
  [ self ]
    (py/call-attr self "reinterpreted_batch_ndims"))
