(ns tensorflow.contrib.distributions.BatchReshape
...
(defn BatchReshape 
  ...
  "
  [distribution batch_shape & {:keys [validate_args allow_nan_stats name]
                       :or {name None}} ]
    (py/call-attr-kw distributions "BatchReshape" [distribution batch_shape] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
