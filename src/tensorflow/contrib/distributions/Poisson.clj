(ns tensorflow.contrib.distributions.Poisson
...
(defn Poisson 
  ...
  "
  [rate log_rate  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "Poisson" [rate log_rate] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
