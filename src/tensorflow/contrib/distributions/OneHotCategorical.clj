(ns tensorflow.contrib.distributions.OneHotCategorical
...
(defn OneHotCategorical 
  ...
  "
  [logits probs  & {:keys [dtype validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "OneHotCategorical" [logits probs] {:dtype dtype :validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
