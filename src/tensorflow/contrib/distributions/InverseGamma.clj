(ns tensorflow.contrib.distributions.InverseGamma
...
(defn InverseGamma 
  ...
  * `Gamma` is the [gamma function](
  ...
  [concentration rate  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "InverseGamma" [concentration rate] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
