(ns tensorflow.contrib.distributions.MultivariateNormalTriL
...
(defn MultivariateNormalTriL 
  ...
  * `||y||**2` denotes the squared Euclidean norm of `y`.
  ...
  "
  [loc scale_tril  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "MultivariateNormalTriL" [loc scale_tril] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
