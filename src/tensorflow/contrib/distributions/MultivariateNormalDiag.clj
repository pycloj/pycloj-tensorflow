(ns tensorflow.contrib.distributions.MultivariateNormalDiag
...
(defn MultivariateNormalDiag 
  ...
  * `scale_identity_multiplier.shape = []`.
  ...
  [loc scale_diag scale_identity_multiplier  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "MultivariateNormalDiag" [loc scale_diag scale_identity_multiplier] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
