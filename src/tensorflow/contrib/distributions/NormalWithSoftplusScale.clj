(ns tensorflow.contrib.distributions.NormalWithSoftplusScale
...
(defn NormalWithSoftplusScale 
  "Normal with softplus applied to `scale`."
  [loc scale  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "NormalWithSoftplusScale" [loc scale] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
