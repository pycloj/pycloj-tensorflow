(ns tensorflow.contrib.distributions.Autoregressive
...
(defn Autoregressive 
  ...
  [2]: Aaron van den Oord, Nal Kalchbrenner, Oriol Vinyals, Lasse Espeholt,
       ...
       https://arxiv.org/abs/1606.05328
  "
  [distribution_fn sample0 num_steps  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "Autoregressive" [distribution_fn sample0 num_steps] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
...
(defn distribution0 
  ""
  [ self ]
    (py/call-attr self "distribution0"))

(defn distribution-fn 
  ""
  [ self ]
    (py/call-attr self "distribution_fn"))
