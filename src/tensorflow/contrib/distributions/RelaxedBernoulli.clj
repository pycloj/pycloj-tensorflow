(ns tensorflow.contrib.distributions.RelaxedBernoulli
...
(defn RelaxedBernoulli 
  ...
  Gumbel-Softmax. 2016.
  "
  [temperature logits probs  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "RelaxedBernoulli" [temperature logits probs] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
