(ns tensorflow.contrib.distributions.HalfNormal
...
(defn HalfNormal 
  ...
  "
  [scale  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "HalfNormal" [scale] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
