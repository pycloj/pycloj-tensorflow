(ns tensorflow.contrib.distributions.ConditionalDistribution
...
(defn ConditionalDistribution 
  ...
  (py/call-attr distributions "ConditionalDistribution"  dtype reparameterization_type validate_args allow_nan_stats parameters graph_parents name ))
