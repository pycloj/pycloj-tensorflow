(ns tensorflow.contrib.distributions.SinhArcsinh
...
(defn SinhArcsinh 
  ...
  * Larger (smaller) `tailweight` leads to fatter (thinner) tails.
  ...
  ```
  "
  [loc scale skewness tailweight distribution  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "SinhArcsinh" [loc scale skewness tailweight distribution] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
