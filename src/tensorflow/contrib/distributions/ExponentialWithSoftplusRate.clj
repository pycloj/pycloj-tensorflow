(ns tensorflow.contrib.distributions.ExponentialWithSoftplusRate
...
(defn ExponentialWithSoftplusRate 
  "Exponential with softplus transform on `rate`."
  [rate  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "ExponentialWithSoftplusRate" [rate] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
