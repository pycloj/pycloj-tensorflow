(ns tensorflow.contrib.distributions.MultivariateNormalDiagWithSoftplusScale
...
(defn MultivariateNormalDiagWithSoftplusScale 
  "MultivariateNormalDiag with `diag_stddev = softplus(diag_stddev)`."
  [loc scale_diag  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "MultivariateNormalDiagWithSoftplusScale" [loc scale_diag] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
