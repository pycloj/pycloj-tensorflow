(ns tensorflow.contrib.distributions.InverseGammaWithSoftplusConcentrationRate
...
(defn InverseGammaWithSoftplusConcentrationRate 
  "`InverseGamma` with softplus of `concentration` and `rate`."
  [concentration rate  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "InverseGammaWithSoftplusConcentrationRate" [concentration rate] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
