(ns tensorflow.contrib.distributions.RelaxedOneHotCategorical
...
(defn RelaxedOneHotCategorical 
  ...
  [temperature logits probs dtype  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "RelaxedOneHotCategorical" [temperature logits probs dtype] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
