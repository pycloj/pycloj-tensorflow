(ns tensorflow.contrib.distributions.VectorDeterministic
...
(defn VectorDeterministic 
  ...
  "
  [loc atol rtol  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "VectorDeterministic" [loc atol rtol] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
