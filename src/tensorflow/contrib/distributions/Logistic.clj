(ns tensorflow.contrib.distributions.Logistic
...
(defn Logistic 
  ...
  [loc scale  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "Logistic" [loc scale] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
