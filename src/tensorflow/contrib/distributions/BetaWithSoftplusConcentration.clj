(ns tensorflow.contrib.distributions.BetaWithSoftplusConcentration
...
(defn BetaWithSoftplusConcentration 
  "Beta with softplus transform of `concentration1` and `concentration0`."
  [concentration1 concentration0  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "BetaWithSoftplusConcentration" [concentration1 concentration0] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
