(ns tensorflow.contrib.distributions.Deterministic
...
(defn Deterministic 
  ...
  [loc atol rtol  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "Deterministic" [loc atol rtol] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
