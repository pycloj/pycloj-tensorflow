(ns tensorflow.contrib.distributions.TransformedDistribution
...
(defn TransformedDistribution 
  ...
  [distribution bijector batch_shape event_shape & {:keys [validate_args name]
                       :or {name None}} ]
    (py/call-attr-kw distributions "TransformedDistribution" [distribution bijector batch_shape event_shape] {:validate_args validate_args :name name }))
