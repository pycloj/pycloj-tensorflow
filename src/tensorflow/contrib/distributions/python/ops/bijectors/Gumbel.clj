(ns tensorflow.contrib.distributions.python.ops.bijectors.Gumbel
...
(defn Gumbel 
  ...
  ```
  "
  [ & {:keys [loc scale validate_args name]} ]
   (py/call-attr-kw bijectors "Gumbel" [] {:loc loc :scale scale :validate_args validate_args :name name }))
