(ns tensorflow.contrib.distributions.python.ops.bijectors.Invert
...
(defn Invert 
  ...
  "
  [bijector & {:keys [validate_args name]
                       :or {name None}} ]
    (py/call-attr-kw bijectors "Invert" [bijector] {:validate_args validate_args :name name }))
