(ns tensorflow.contrib.distributions.python.ops.bijectors.CholeskyOuterProduct
...
(defn CholeskyOuterProduct 
  ...
  "
  [ & {:keys [validate_args name]} ]
   (py/call-attr-kw bijectors "CholeskyOuterProduct" [] {:validate_args validate_args :name name }))
