(ns tensorflow.contrib.distributions.python.ops.bijectors.TransformDiagonal
...
(defn TransformDiagonal 
  ...
  "
  [diag_bijector  & {:keys [validate_args name]} ]
    (py/call-attr-kw bijectors "TransformDiagonal" [diag_bijector] {:validate_args validate_args :name name }))
