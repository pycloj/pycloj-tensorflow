(ns tensorflow.contrib.distributions.python.ops.bijectors.Inline
...
(defn Inline 
  ...
  The above example is equivalent to the `Bijector` `Exp()`.
  "
  [forward_fn inverse_fn inverse_log_det_jacobian_fn forward_log_det_jacobian_fn forward_event_shape_fn forward_event_shape_tensor_fn inverse_event_shape_fn inverse_event_shape_tensor_fn & {:keys [is_constant_jacobian validate_args forward_min_event_ndims inverse_min_event_ndims name]
                       :or {forward_min_event_ndims None inverse_min_event_ndims None}} ]
    (py/call-attr-kw bijectors "Inline" [forward_fn inverse_fn inverse_log_det_jacobian_fn forward_log_det_jacobian_fn forward_event_shape_fn forward_event_shape_tensor_fn inverse_event_shape_fn inverse_event_shape_tensor_fn] {:is_constant_jacobian is_constant_jacobian :validate_args validate_args :forward_min_event_ndims forward_min_event_ndims :inverse_min_event_ndims inverse_min_event_ndims :name name }))
