(ns tensorflow.contrib.distributions.python.ops.bijectors.Chain
...
(defn Chain 
  ...
  * Inverse:
  ...
  "
  [bijectors & {:keys [validate_args name]
                       :or {name None}} ]
    (py/call-attr-kw bijectors "Chain" [bijectors] {:validate_args validate_args :name name }))
