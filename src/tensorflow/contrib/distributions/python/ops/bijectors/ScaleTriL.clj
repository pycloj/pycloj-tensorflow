(ns tensorflow.contrib.distributions.python.ops.bijectors.ScaleTriL
...
(defn ScaleTriL 
  ...
  ```
  "
  [diag_bijector  & {:keys [diag_shift validate_args name]} ]
    (py/call-attr-kw bijectors "ScaleTriL" [diag_bijector] {:diag_shift diag_shift :validate_args validate_args :name name }))

(defn bijectors 
  ""
  [ self ]
    (py/call-attr self "bijectors"))
