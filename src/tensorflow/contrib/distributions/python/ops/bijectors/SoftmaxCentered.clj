(ns tensorflow.contrib.distributions.python.ops.bijectors.SoftmaxCentered
...
(defn SoftmaxCentered 
  ...
  [ & {:keys [validate_args name]} ]
   (py/call-attr-kw bijectors "SoftmaxCentered" [] {:validate_args validate_args :name name }))
