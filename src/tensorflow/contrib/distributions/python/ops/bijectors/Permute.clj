(ns tensorflow.contrib.distributions.python.ops.bijectors.Permute
...
(defn Permute 
  ...
  "
  [permutation & {:keys [validate_args name]
                       :or {name None}} ]
    (py/call-attr-kw bijectors "Permute" [permutation] {:validate_args validate_args :name name }))
