(ns tensorflow.contrib.distributions.python.ops.bijectors.MatrixInverseTriL
...
(defn MatrixInverseTriL 
  ...
  [ & {:keys [validate_args name]} ]
   (py/call-attr-kw bijectors "MatrixInverseTriL" [] {:validate_args validate_args :name name }))
