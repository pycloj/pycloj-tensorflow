(ns tensorflow.contrib.distributions.python.ops.bijectors.Affine
...
(defn Affine 
  ...
  "
  [shift scale_identity_multiplier scale_diag scale_tril scale_perturb_factor scale_perturb_diag  & {:keys [validate_args name]} ]
    (py/call-attr-kw bijectors "Affine" [shift scale_identity_multiplier scale_diag scale_tril scale_perturb_factor scale_perturb_diag] {:validate_args validate_args :name name }))
