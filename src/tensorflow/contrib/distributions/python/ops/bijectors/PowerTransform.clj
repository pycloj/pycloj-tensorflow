(ns tensorflow.contrib.distributions.python.ops.bijectors.PowerTransform
...
(defn PowerTransform 
  ...
  This bijector is equivalent to the `Exp` bijector when `c=0`.
  "
  [ & {:keys [power validate_args name]} ]
   (py/call-attr-kw bijectors "PowerTransform" [] {:power power :validate_args validate_args :name name }))
