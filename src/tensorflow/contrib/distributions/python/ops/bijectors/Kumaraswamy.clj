(ns tensorflow.contrib.distributions.python.ops.bijectors.Kumaraswamy
...
(defn Kumaraswamy 
  ...
  ```
  "
  [concentration1 concentration0  & {:keys [validate_args name]} ]
    (py/call-attr-kw bijectors "Kumaraswamy" [concentration1 concentration0] {:validate_args validate_args :name name }))
