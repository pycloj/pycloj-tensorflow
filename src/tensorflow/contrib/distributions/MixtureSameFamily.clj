(ns tensorflow.contrib.distributions.MixtureSameFamily
...
(defn MixtureSameFamily 
  ...
  "
  [mixture_distribution components_distribution  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "MixtureSameFamily" [mixture_distribution components_distribution] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
...
(defn components-distribution 
  ""
  [ self ]
    (py/call-attr self "components_distribution"))
