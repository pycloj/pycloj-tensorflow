(ns tensorflow.contrib.distributions.Cauchy
...
(defn Cauchy 
  ...
  [loc scale  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "Cauchy" [loc scale] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
