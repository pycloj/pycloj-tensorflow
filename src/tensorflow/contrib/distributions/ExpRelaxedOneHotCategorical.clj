(ns tensorflow.contrib.distributions.ExpRelaxedOneHotCategorical
...
(defn ExpRelaxedOneHotCategorical 
  "ExpRelaxedOneHotCategorical distribution with temperature and logits.
  ...
  A Continuous Relaxation of Discrete Random Variables. 2016.
  "
  [temperature logits probs dtype  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "ExpRelaxedOneHotCategorical" [temperature logits probs dtype] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
