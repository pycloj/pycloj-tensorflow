(ns tensorflow.contrib.learn.python.learn.monitors.LoggingTrainable
...
(defn LoggingTrainable 
  ...
  starting with the `first_n`th step.
  "
  [scope  & {:keys [every_n first_n]} ]
    (py/call-attr-kw monitors "LoggingTrainable" [scope] {:every_n every_n :first_n first_n }))
