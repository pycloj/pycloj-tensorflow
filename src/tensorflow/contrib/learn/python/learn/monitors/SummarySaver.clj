(ns tensorflow.contrib.learn.python.learn.monitors.SummarySaver
...
(defn SummarySaver 
  ...
  for general migration instructions.
  "
  [summary_op & {:keys [save_steps output_dir summary_writer scaffold]
                       :or {output_dir None summary_writer None scaffold None}} ]
    (py/call-attr-kw monitors "SummarySaver" [summary_op] {:save_steps save_steps :output_dir output_dir :summary_writer summary_writer :scaffold scaffold }))
