(ns tensorflow.contrib.learn.python.learn.monitors.CaptureVariable
...
(defn CaptureVariable 
  ...
  and `first_n`.
  "
  [var_name  & {:keys [every_n first_n]} ]
    (py/call-attr-kw monitors "CaptureVariable" [var_name] {:every_n every_n :first_n first_n }))
