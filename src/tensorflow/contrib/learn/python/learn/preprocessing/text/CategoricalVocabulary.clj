(ns tensorflow.contrib.learn.python.learn.preprocessing.text.CategoricalVocabulary
...
(defn CategoricalVocabulary 
  ...
  [ & {:keys [unknown_token support_reverse]} ]
   (py/call-attr-kw text "CategoricalVocabulary" [] {:unknown_token unknown_token :support_reverse support_reverse }))
(defn add 
