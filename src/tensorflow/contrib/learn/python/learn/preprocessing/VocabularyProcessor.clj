(ns tensorflow.contrib.learn.python.learn.preprocessing.VocabularyProcessor
...
(defn VocabularyProcessor 
  ...
  [max_document_length & {:keys [min_frequency vocabulary tokenizer_fn]
    ...
    (py/call-attr-kw preprocessing "VocabularyProcessor" [max_document_length] {:min_frequency min_frequency :vocabulary vocabulary :tokenizer_fn tokenizer_fn }))
