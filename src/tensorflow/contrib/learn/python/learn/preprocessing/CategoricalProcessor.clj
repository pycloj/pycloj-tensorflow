(ns tensorflow.contrib.learn.python.learn.preprocessing.CategoricalProcessor
...
(defn CategoricalProcessor 
  ...
  [ & {:keys [min_frequency share vocabularies]
   ...
   (py/call-attr-kw preprocessing "CategoricalProcessor" [] {:min_frequency min_frequency :share share :vocabularies vocabularies }))
