(ns tensorflow.contrib.learn.python.learn.preprocessing.text
...
for general migration instructions."
  [ max_document_length ]
  (py/call-attr text "ByteProcessor"  max_document_length ))
(defn deprecated 
  ...
  [date instructions  & {:keys [warn_once]} ]
    (py/call-attr-kw text "deprecated" [date instructions] {:warn_once warn_once }))
...
Yields:
  ...
  [ iterator ]
  (py/call-attr text "tokenizer"  iterator ))
