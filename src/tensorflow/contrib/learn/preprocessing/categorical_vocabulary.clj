(ns tensorflow.contrib.learn.python.learn.preprocessing.categorical-vocabulary
...
(defn deprecated 
  ...
  [date instructions  & {:keys [warn_once]} ]
    (py/call-attr-kw categorical-vocabulary "deprecated" [date instructions] {:warn_once warn_once }))
