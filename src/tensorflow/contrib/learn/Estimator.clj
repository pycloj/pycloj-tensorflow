(ns tensorflow.contrib.learn.Estimator
...
(defn Estimator 
  ...
  for general migration instructions.
  "
  [ model_fn model_dir config params feature_engineering_fn ]
  (py/call-attr learn "Estimator"  model_fn model_dir config params feature_engineering_fn ))
