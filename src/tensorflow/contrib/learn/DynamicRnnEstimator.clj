(ns tensorflow.contrib.learn.DynamicRnnEstimator
...
(defn DynamicRnnEstimator 
  ...
  for general migration instructions.
  "
  [problem_type prediction_type sequence_feature_columns context_feature_columns num_classes num_units & {:keys [cell_type optimizer learning_rate predict_probabilities momentum gradient_clipping_norm dropout_keep_probabilities model_dir feature_engineering_fn config]
                       :or {momentum None dropout_keep_probabilities None model_dir None feature_engineering_fn None config None}} ]
    (py/call-attr-kw learn "DynamicRnnEstimator" [problem_type prediction_type sequence_feature_columns context_feature_columns num_classes num_units] {:cell_type cell_type :optimizer optimizer :learning_rate learning_rate :predict_probabilities predict_probabilities :momentum momentum :gradient_clipping_norm gradient_clipping_norm :dropout_keep_probabilities dropout_keep_probabilities :model_dir model_dir :feature_engineering_fn feature_engineering_fn :config config }))
