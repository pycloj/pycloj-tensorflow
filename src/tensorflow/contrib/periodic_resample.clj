(ns tensorflow.contrib.periodic-resample
...
(py/initialize!)
(defonce periodic-resample (import-module "tensorflow.contrib.periodic_resample"))

(defn periodic-resample 
  ...
  "
  [ values shape name ]
  (py/call-attr periodic-resample "periodic_resample"  values shape name ))
