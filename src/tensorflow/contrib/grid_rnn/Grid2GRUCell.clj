(ns tensorflow.contrib.grid-rnn.Grid2GRUCell
  "2D LSTM cell.
...
(defn Grid2GRUCell 
  ...
  [num_units & {:keys [tied non_recurrent_fn state_is_tuple output_is_tuple]
    ...
    (py/call-attr-kw grid-rnn "Grid2GRUCell" [num_units] {:tied tied :non_recurrent_fn non_recurrent_fn :state_is_tuple state_is_tuple :output_is_tuple output_is_tuple }))
