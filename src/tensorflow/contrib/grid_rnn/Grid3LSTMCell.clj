(ns tensorflow.contrib.grid-rnn.Grid3LSTMCell
  "3D BasicLSTM cell.
...
(defn Grid3LSTMCell 
  "3D BasicLSTM cell.
    ...
    The second and third dimensions are LSTM.
  "
  [num_units & {:keys [tied non_recurrent_fn use_peepholes forget_bias state_is_tuple output_is_tuple]
                       :or {non_recurrent_fn None}} ]
    (py/call-attr-kw grid-rnn "Grid3LSTMCell" [num_units] {:tied tied :non_recurrent_fn non_recurrent_fn :use_peepholes use_peepholes :forget_bias forget_bias :state_is_tuple state_is_tuple :output_is_tuple output_is_tuple }))
