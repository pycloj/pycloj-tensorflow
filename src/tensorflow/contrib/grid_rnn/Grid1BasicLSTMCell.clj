(ns tensorflow.contrib.grid-rnn.Grid1BasicLSTMCell
  "1D BasicLSTM cell."
...
(defn Grid1BasicLSTMCell 
  "1D BasicLSTM cell."
  [num_units  & {:keys [forget_bias state_is_tuple output_is_tuple]} ]
    (py/call-attr-kw grid-rnn "Grid1BasicLSTMCell" [num_units] {:forget_bias forget_bias :state_is_tuple state_is_tuple :output_is_tuple output_is_tuple }))
