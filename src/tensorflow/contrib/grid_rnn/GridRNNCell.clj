(ns tensorflow.contrib.grid-rnn.GridRNNCell
  "Grid recurrent cell.
...
(py/initialize!)
(defonce grid-rnn (import-module "tensorflow.contrib.grid_rnn"))
...
(defn GridRNNCell 
  ...
  This implementation is based on:
    ...
    Type of recurrent units can be specified via `cell_fn`.
  "
  [num_units & {:keys [num_dims input_dims output_dims priority_dims non_recurrent_dims tied cell_fn non_recurrent_fn state_is_tuple output_is_tuple]
                       :or {input_dims None output_dims None priority_dims None non_recurrent_dims None cell_fn None non_recurrent_fn None}} ]
    (py/call-attr-kw grid-rnn "GridRNNCell" [num_units] {:num_dims num_dims :input_dims input_dims :output_dims output_dims :priority_dims priority_dims :non_recurrent_dims non_recurrent_dims :tied tied :cell_fn cell_fn :non_recurrent_fn non_recurrent_fn :state_is_tuple state_is_tuple :output_is_tuple output_is_tuple }))
