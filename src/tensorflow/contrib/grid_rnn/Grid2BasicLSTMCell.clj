(ns tensorflow.contrib.grid-rnn.Grid2BasicLSTMCell
  "2D BasicLSTM cell.
...
(defn Grid2BasicLSTMCell 
  ...
  specified.
  "
  [num_units & {:keys [tied non_recurrent_fn forget_bias state_is_tuple output_is_tuple]
                       :or {non_recurrent_fn None}} ]
    (py/call-attr-kw grid-rnn "Grid2BasicLSTMCell" [num_units] {:tied tied :non_recurrent_fn non_recurrent_fn :forget_bias forget_bias :state_is_tuple state_is_tuple :output_is_tuple output_is_tuple }))
