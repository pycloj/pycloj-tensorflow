(ns tensorflow.contrib.grid-rnn.python.ops.grid-rnn-cell.Grid1LSTMCell
  "1D LSTM cell.
...
(defn Grid1LSTMCell 
  ...
  [num_units  & {:keys [use_peepholes forget_bias state_is_tuple output_is_tuple]} ]
    (py/call-attr-kw grid-rnn-cell "Grid1LSTMCell" [num_units] {:use_peepholes use_peepholes :forget_bias forget_bias :state_is_tuple state_is_tuple :output_is_tuple output_is_tuple }))
