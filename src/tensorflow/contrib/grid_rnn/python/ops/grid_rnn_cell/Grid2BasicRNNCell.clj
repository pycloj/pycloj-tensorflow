(ns tensorflow.contrib.grid-rnn.python.ops.grid-rnn-cell.Grid2BasicRNNCell
  "2D BasicRNN cell
...
(defn Grid2BasicRNNCell 
  ...
  [num_units & {:keys [tied non_recurrent_fn state_is_tuple output_is_tuple]
    ...
    (py/call-attr-kw grid-rnn-cell "Grid2BasicRNNCell" [num_units] {:tied tied :non_recurrent_fn non_recurrent_fn :state_is_tuple state_is_tuple :output_is_tuple output_is_tuple }))
