(ns tensorflow.contrib.grid-rnn.python.ops.grid-rnn-cell.GridRNNCell
  "Grid recurrent cell.
...
(defn GridRNNCell 
  ...
  [num_units & {:keys [num_dims input_dims output_dims priority_dims non_recurrent_dims tied cell_fn non_recurrent_fn state_is_tuple output_is_tuple]
    ...
    (py/call-attr-kw grid-rnn-cell "GridRNNCell" [num_units] {:num_dims num_dims :input_dims input_dims :output_dims output_dims :priority_dims priority_dims :non_recurrent_dims non_recurrent_dims :tied tied :cell_fn cell_fn :non_recurrent_fn non_recurrent_fn :state_is_tuple state_is_tuple :output_is_tuple output_is_tuple }))
