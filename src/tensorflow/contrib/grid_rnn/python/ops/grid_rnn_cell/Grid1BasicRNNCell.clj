(ns tensorflow.contrib.grid-rnn.python.ops.grid-rnn-cell.Grid1BasicRNNCell
  "1D BasicRNN cell"
...
(defn Grid1BasicRNNCell 
  ...
  [num_units  & {:keys [state_is_tuple output_is_tuple]} ]
    (py/call-attr-kw grid-rnn-cell "Grid1BasicRNNCell" [num_units] {:state_is_tuple state_is_tuple :output_is_tuple output_is_tuple }))
