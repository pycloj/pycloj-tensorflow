(ns tensorflow.contrib.grid-rnn.python.ops.grid-rnn-cell.Grid3LSTMCell
  "3D BasicLSTM cell.
...
(defn Grid3LSTMCell 
  ...
  [num_units & {:keys [tied non_recurrent_fn use_peepholes forget_bias state_is_tuple output_is_tuple]
    ...
    (py/call-attr-kw grid-rnn-cell "Grid3LSTMCell" [num_units] {:tied tied :non_recurrent_fn non_recurrent_fn :use_peepholes use_peepholes :forget_bias forget_bias :state_is_tuple state_is_tuple :output_is_tuple output_is_tuple }))
