(ns tensorflow.contrib.grid-rnn.python.ops.grid-rnn-cell.Grid2BasicLSTMCell
  "2D BasicLSTM cell.
...
(defn Grid2BasicLSTMCell 
  ...
  [num_units & {:keys [tied non_recurrent_fn forget_bias state_is_tuple output_is_tuple]
    ...
    (py/call-attr-kw grid-rnn-cell "Grid2BasicLSTMCell" [num_units] {:tied tied :non_recurrent_fn non_recurrent_fn :forget_bias forget_bias :state_is_tuple state_is_tuple :output_is_tuple output_is_tuple }))
