(ns tensorflow.contrib.grid-rnn.Grid2LSTMCell
  "2D LSTM cell.
...
(defn Grid2LSTMCell 
  ...
  [num_units & {:keys [tied non_recurrent_fn use_peepholes forget_bias state_is_tuple output_is_tuple]
    ...
    (py/call-attr-kw grid-rnn "Grid2LSTMCell" [num_units] {:tied tied :non_recurrent_fn non_recurrent_fn :use_peepholes use_peepholes :forget_bias forget_bias :state_is_tuple state_is_tuple :output_is_tuple output_is_tuple }))
