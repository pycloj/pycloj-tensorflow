(ns tensorflow.contrib.grid-rnn.Grid1LSTMCell
  "1D LSTM cell.
...
(defn Grid1LSTMCell 
  ...
  specify the forget bias and enabling peepholes.
  "
  [num_units  & {:keys [use_peepholes forget_bias state_is_tuple output_is_tuple]} ]
    (py/call-attr-kw grid-rnn "Grid1LSTMCell" [num_units] {:use_peepholes use_peepholes :forget_bias forget_bias :state_is_tuple state_is_tuple :output_is_tuple output_is_tuple }))
