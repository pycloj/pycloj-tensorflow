(ns tensorflow.contrib.constrained-optimization.MultiplicativeSwapRegretOptimizer
...
(defn MultiplicativeSwapRegretOptimizer 
  "A `ConstrainedOptimizer` based on swap-regret minimization.
  ...
  the \"inner\" updates.
  "
  [optimizer constraint_optimizer & {:keys [minimum_multiplier_radius initial_multiplier_radius]
                       :or {initial_multiplier_radius None}} ]
    (py/call-attr-kw constrained-optimization "MultiplicativeSwapRegretOptimizer" [optimizer constraint_optimizer] {:minimum_multiplier_radius minimum_multiplier_radius :initial_multiplier_radius initial_multiplier_radius }))
