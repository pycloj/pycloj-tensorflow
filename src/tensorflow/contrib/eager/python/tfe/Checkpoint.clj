(ns tensorflow.contrib.eager.python.tfe.Checkpoint
...
(defn save 
  ...
  (py/call-attr self "save"  self file_prefix session ))
...
(defn write 
  "Writes a training checkpoint.
    ...
    "
  [ self file_prefix session ]
  (py/call-attr self "write"  self file_prefix session ))
