(ns tensorflow.contrib.rnn.PhasedLSTMCell
...
(defn PhasedLSTMCell 
  ...
  https://arxiv.org/pdf/1610.09513v1.pdf
  "
  [num_units & {:keys [use_peepholes leak ratio_on trainable_ratio_on period_init_min period_init_max reuse]
                       :or {reuse None}} ]
    (py/call-attr-kw rnn "PhasedLSTMCell" [num_units] {:use_peepholes use_peepholes :leak leak :ratio_on ratio_on :trainable_ratio_on trainable_ratio_on :period_init_min period_init_min :period_init_max period_init_max :reuse reuse }))
