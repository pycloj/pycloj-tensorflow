(ns tensorflow.contrib.rnn.GRUBlockCellV2
...
(defn GRUBlockCellV2 
  ...
  Only differs from GRUBlockCell by variable names.
  "
  [num_units cell_size reuse  & {:keys [name]} ]
    (py/call-attr-kw rnn "GRUBlockCellV2" [num_units cell_size reuse] {:name name }))
...
(defn call 
  "GRU cell."
  [ self inputs h_prev ]
  (py/call-attr self "call"  self inputs h_prev ))
