(ns tensorflow.contrib.rnn.IndyLSTMCell
...
(defn IndyLSTMCell 
  ...
  For a detailed analysis of IndyLSTMs, see https://arxiv.org/abs/1903.08023.
  "
  [num_units & {:keys [forget_bias activation reuse kernel_initializer bias_initializer name dtype]
                       :or {activation None reuse None kernel_initializer None bias_initializer None name None dtype None}} ]
    (py/call-attr-kw rnn "IndyLSTMCell" [num_units] {:forget_bias forget_bias :activation activation :reuse reuse :kernel_initializer kernel_initializer :bias_initializer bias_initializer :name name :dtype dtype }))
