(ns tensorflow.contrib.rnn.AttentionCellWrapper
...
(defn AttentionCellWrapper 
  "Basic attention cell wrapper.

  Implementation based on https://arxiv.org/abs/1601.06733.
  "
  [cell attn_length attn_size attn_vec_size input_size & {:keys [state_is_tuple reuse]
                       :or {reuse None}} ]
    (py/call-attr-kw rnn "AttentionCellWrapper" [cell attn_length attn_size attn_vec_size input_size] {:state_is_tuple state_is_tuple :reuse reuse }))
