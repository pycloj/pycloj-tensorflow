(ns tensorflow.contrib.rnn.CoupledInputForgetGateLSTMCell
...
(defn CoupledInputForgetGateLSTMCell 
  "Long short-term memory unit (LSTM) recurrent network cell.
  ...
  "
  [num_units & {:keys [use_peepholes initializer num_proj proj_clip num_unit_shards num_proj_shards forget_bias state_is_tuple activation reuse layer_norm norm_gain norm_shift]
                       :or {initializer None num_proj None proj_clip None reuse None}} ]
    (py/call-attr-kw rnn "CoupledInputForgetGateLSTMCell" [num_units] {:use_peepholes use_peepholes :initializer initializer :num_proj num_proj :proj_clip proj_clip :num_unit_shards num_unit_shards :num_proj_shards num_proj_shards :forget_bias forget_bias :state_is_tuple state_is_tuple :activation activation :reuse reuse :layer_norm layer_norm :norm_gain norm_gain :norm_shift norm_shift }))
