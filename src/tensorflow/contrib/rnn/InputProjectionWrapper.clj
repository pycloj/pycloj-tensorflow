(ns tensorflow.contrib.rnn.InputProjectionWrapper
...
(defn InputProjectionWrapper 
  ...
  do the projection on this batch-concatenated sequence, then split it.
  "
  [ cell num_proj activation input_size reuse ]
  (py/call-attr rnn "InputProjectionWrapper"  cell num_proj activation input_size reuse ))
