(ns tensorflow.contrib.rnn.TimeFreqLSTMCell
...
(defn TimeFreqLSTMCell 
  ...
  It uses peep-hole connections and optional cell clipping.
  "
  [num_units & {:keys [use_peepholes cell_clip initializer num_unit_shards forget_bias feature_size frequency_skip reuse]
                       :or {cell_clip None initializer None feature_size None reuse None}} ]
    (py/call-attr-kw rnn "TimeFreqLSTMCell" [num_units] {:use_peepholes use_peepholes :cell_clip cell_clip :initializer initializer :num_unit_shards num_unit_shards :forget_bias forget_bias :feature_size feature_size :frequency_skip frequency_skip :reuse reuse }))
