(ns tensorflow.contrib.rnn.LayerNormBasicLSTMCell
...
(defn LayerNormBasicLSTMCell 
  ...
  Stanislau Semeniuta, Aliaksei Severyn, Erhardt Barth.
  "
  [num_units & {:keys [forget_bias input_size activation layer_norm norm_gain norm_shift dropout_keep_prob dropout_prob_seed reuse]
                       :or {input_size None dropout_prob_seed None reuse None}} ]
    (py/call-attr-kw rnn "LayerNormBasicLSTMCell" [num_units] {:forget_bias forget_bias :input_size input_size :activation activation :layer_norm layer_norm :norm_gain norm_gain :norm_shift norm_shift :dropout_keep_prob dropout_keep_prob :dropout_prob_seed dropout_prob_seed :reuse reuse }))
