(ns tensorflow.contrib.rnn.LSTMBlockFusedCell
...
(defn LSTMBlockFusedCell 
  ...
  The variable naming is consistent with `rnn_cell_impl.LSTMCell`.
  "
  [num_units & {:keys [forget_bias cell_clip use_peephole reuse dtype name]
                       :or {cell_clip None reuse None dtype None}} ]
    (py/call-attr-kw rnn "LSTMBlockFusedCell" [num_units] {:forget_bias forget_bias :cell_clip cell_clip :use_peephole use_peephole :reuse reuse :dtype dtype :name name }))
