(ns tensorflow.contrib.rnn.HighwayWrapper
...
(defn HighwayWrapper 
  ...
  Based on:
    ...
    https://arxiv.org/abs/1505.00387
  "
  [cell  & {:keys [couple_carry_transform_gates carry_bias_init]} ]
    (py/call-attr-kw rnn "HighwayWrapper" [cell] {:couple_carry_transform_gates couple_carry_transform_gates :carry_bias_init carry_bias_init }))
