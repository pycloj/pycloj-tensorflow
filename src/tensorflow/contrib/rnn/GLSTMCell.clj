(ns tensorflow.contrib.rnn.GLSTMCell
...
(defn GLSTMCell 
  ...
  of the input and produces a 32-dim part of the output.
  "
  [num_units initializer num_proj & {:keys [number_of_groups forget_bias activation reuse]
                       :or {reuse None}} ]
    (py/call-attr-kw rnn "GLSTMCell" [num_units initializer num_proj] {:number_of_groups number_of_groups :forget_bias forget_bias :activation activation :reuse reuse }))
