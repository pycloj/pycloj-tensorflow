(ns tensorflow.contrib.rnn.CompiledWrapper
...
(defn CompiledWrapper 
  "Wraps step execution in an XLA JIT scope."
  [cell  & {:keys [compile_stateful]} ]
    (py/call-attr-kw rnn "CompiledWrapper" [cell] {:compile_stateful compile_stateful }))
