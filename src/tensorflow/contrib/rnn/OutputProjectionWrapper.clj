(ns tensorflow.contrib.rnn.OutputProjectionWrapper
...
(defn OutputProjectionWrapper 
  ...
  if needed or directly feed into a softmax.
  "
  [ cell output_size activation reuse ]
  (py/call-attr rnn "OutputProjectionWrapper"  cell output_size activation reuse ))
