(ns tensorflow.contrib.rnn.BasicLSTMCell
...
(defn BasicLSTMCell 
  ...
  [num_units & {:keys [forget_bias state_is_tuple activation reuse name dtype]
    ...
    (py/call-attr-kw rnn "BasicLSTMCell" [num_units] {:forget_bias forget_bias :state_is_tuple state_is_tuple :activation activation :reuse reuse :name name :dtype dtype }))
