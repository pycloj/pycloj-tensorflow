(ns tensorflow.contrib.rnn.UGRNNCell
...
(defn UGRNNCell 
  ...
  \"Capacity and Trainability in Recurrent Neural Networks\" Proc. ICLR 2017.
  "
  [num_units initializer & {:keys [forget_bias activation reuse]
                       :or {reuse None}} ]
    (py/call-attr-kw rnn "UGRNNCell" [num_units initializer] {:forget_bias forget_bias :activation activation :reuse reuse }))
