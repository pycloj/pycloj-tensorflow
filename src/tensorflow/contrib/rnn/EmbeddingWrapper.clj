(ns tensorflow.contrib.rnn.EmbeddingWrapper
...
(defn EmbeddingWrapper 
  ...
  feed into your RNN.
  "
  [ cell embedding_classes embedding_size initializer reuse ]
  (py/call-attr rnn "EmbeddingWrapper"  cell embedding_classes embedding_size initializer reuse ))
