(ns tensorflow.contrib.rnn.LSTMBlockCell
...
(defn LSTMBlockCell 
  ...
  variable scope matches.
  "
  [num_units & {:keys [forget_bias cell_clip use_peephole dtype reuse name]
                       :or {cell_clip None dtype None reuse None}} ]
    (py/call-attr-kw rnn "LSTMBlockCell" [num_units] {:forget_bias forget_bias :cell_clip cell_clip :use_peephole use_peephole :dtype dtype :reuse reuse :name name }))
