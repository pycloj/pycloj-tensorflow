(ns tensorflow.contrib.rnn.IntersectionRNNCell
...
(defn IntersectionRNNCell 
  ...
  RNNs so it may not achieve best performance with depth 1.
  "
  [num_units num_in_proj initializer & {:keys [forget_bias y_activation reuse]
                       :or {reuse None}} ]
    (py/call-attr-kw rnn "IntersectionRNNCell" [num_units num_in_proj initializer] {:forget_bias forget_bias :y_activation y_activation :reuse reuse }))
