(ns tensorflow.contrib.rnn.GridLSTMCell
...
(defn GridLSTMCell 
  ...
  The code uses optional peephole connections, shared_weights and cell clipping.
  "
  [num_units & {:keys [use_peepholes share_time_frequency_weights cell_clip initializer num_unit_shards forget_bias feature_size frequency_skip num_frequency_blocks start_freqindex_list end_freqindex_list couple_input_forget_gates state_is_tuple reuse]
