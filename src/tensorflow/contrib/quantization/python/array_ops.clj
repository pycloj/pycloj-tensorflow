...
(py/initialize!)
(defonce array-ops (import-module "tensorflow.contrib.quantization.python.array_ops"))
...
(defn dequantize 
  ...
  *SCALED mode Example*
  ...
  [input min_range max_range & {:keys [mode name]
                       :or {name None}} ]
    (py/call-attr-kw array-ops "dequantize" [input min_range max_range] {:mode mode :name name }))
...
(defn quantize-v2 
  ...
  *SCALED mode Example*
  ...
  [input min_range max_range T & {:keys [mode round_mode name]
                       :or {name None}} ]
    (py/call-attr-kw array-ops "quantize_v2" [input min_range max_range T] {:mode mode :round_mode round_mode :name name }))
...
(defn quantized-concat 
  ...
  (py/call-attr array-ops "quantized_concat"  concat_dim values input_mins input_maxes name ))
