(ns tensorflow.contrib.factorization.KMeansClustering
...
(defn KMeansClustering 
  ...
  ```
  "
  [num_clusters model_dir & {:keys [initial_clusters distance_metric random_seed use_mini_batch mini_batch_steps_per_iteration kmeans_plus_plus_num_retries relative_tolerance config feature_columns]
                       :or {relative_tolerance None config None feature_columns None}} ]
