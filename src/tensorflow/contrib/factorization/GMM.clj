(ns tensorflow.contrib.factorization.GMM
...
(defn GMM 
  "An estimator for GMM clustering."
  [num_clusters model_dir & {:keys [random_seed params initial_clusters covariance_type config]
                       :or {config None}} ]
    (py/call-attr-kw factorization "GMM" [num_clusters model_dir] {:random_seed random_seed :params params :initial_clusters initial_clusters :covariance_type covariance_type :config config }))
...
(defn predict-assignments 
  "See BaseEstimator.predict."
  [ self input_fn batch_size outputs ]
  (py/call-attr self "predict_assignments"  self input_fn batch_size outputs ))
...
(defn score 
  "Predict total log-likelihood.
    ...
    "
  [ self input_fn batch_size steps ]
  (py/call-attr self "score"  self input_fn batch_size steps ))
...
(defn weights 
  ...
  [ self  ]
  (py/call-attr self "weights"  self  ))
