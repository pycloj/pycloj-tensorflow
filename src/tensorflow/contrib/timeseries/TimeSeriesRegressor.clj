(ns tensorflow.contrib.timeseries.TimeSeriesRegressor
...
(defn TimeSeriesRegressor 
  "An Estimator to fit and evaluate a time series model."
  [model state_manager optimizer model_dir config  & {:keys [head_type]} ]
    (py/call-attr-kw timeseries "TimeSeriesRegressor" [model state_manager optimizer model_dir config] {:head_type head_type }))
