(ns tensorflow.contrib.timeseries.ARRegressor
...
(defn ARRegressor 
  ...
  evaluation, although it may be seeded for deterministic evaluation.
  "
  [periodicities input_window_size output_window_size num_features exogenous_feature_columns & {:keys [num_time_buckets loss hidden_layer_sizes anomaly_prior_probability anomaly_distribution optimizer model_dir config]
                       :or {hidden_layer_sizes None anomaly_prior_probability None anomaly_distribution None optimizer None model_dir None config None}} ]
    (py/call-attr-kw timeseries "ARRegressor" [periodicities input_window_size output_window_size num_features exogenous_feature_columns] {:num_time_buckets num_time_buckets :loss loss :hidden_layer_sizes hidden_layer_sizes :anomaly_prior_probability anomaly_prior_probability :anomaly_distribution anomaly_distribution :optimizer optimizer :model_dir model_dir :config config }))
