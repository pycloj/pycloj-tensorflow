(ns tensorflow.contrib.model-pruning.MaskedBasicLSTMCell
...
(defn MaskedBasicLSTMCell 
  ...
  that follows.
  "
  [num_units & {:keys [forget_bias state_is_tuple activation reuse name]
                       :or {activation None reuse None name None}} ]
    (py/call-attr-kw model-pruning "MaskedBasicLSTMCell" [num_units] {:forget_bias forget_bias :state_is_tuple state_is_tuple :activation activation :reuse reuse :name name }))
