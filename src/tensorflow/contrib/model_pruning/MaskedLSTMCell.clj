(ns tensorflow.contrib.model-pruning.MaskedLSTMCell
...
(defn MaskedLSTMCell 
  ...
  projection matrix.
  "
  [num_units & {:keys [use_peepholes cell_clip initializer num_proj proj_clip num_unit_shards num_proj_shards forget_bias state_is_tuple activation reuse]
                       :or {cell_clip None initializer None num_proj None proj_clip None num_unit_shards None num_proj_shards None activation None reuse None}} ]
    (py/call-attr-kw model-pruning "MaskedLSTMCell" [num_units] {:use_peepholes use_peepholes :cell_clip cell_clip :initializer initializer :num_proj num_proj :proj_clip proj_clip :num_unit_shards num_unit_shards :num_proj_shards num_proj_shards :forget_bias forget_bias :state_is_tuple state_is_tuple :activation activation :reuse reuse }))
