(ns tensorflow.contrib.tfprof.ProfileContext
...
(py/initialize!)
(defonce tfprof (import-module "tensorflow.contrib.tfprof"))
(defn ProfileContext 
  "A Context that captures RunMetadata and performs profiling.
  ...
  [profile_dir trace_steps dump_steps  & {:keys [enabled debug]} ]
    (py/call-attr-kw tfprof "ProfileContext" [profile_dir trace_steps dump_steps] {:enabled enabled :debug debug }))
