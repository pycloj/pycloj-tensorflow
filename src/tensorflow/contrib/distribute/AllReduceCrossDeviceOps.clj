(ns tensorflow.contrib.distribute.AllReduceCrossDeviceOps
...
(defn AllReduceCrossDeviceOps 
  "Reduction using all-reduce."
  [ & {:keys [all_reduce_alg num_packs agg_small_grads_max_bytes agg_small_grads_max_group]} ]
   (py/call-attr-kw distribute "AllReduceCrossDeviceOps" [] {:all_reduce_alg all_reduce_alg :num_packs num_packs :agg_small_grads_max_bytes agg_small_grads_max_bytes :agg_small_grads_max_group agg_small_grads_max_group }))
