(ns tensorflow.contrib.distribute.ParameterServerStrategy
...
(defn ParameterServerStrategy 
  ...
  *** contrib version ***
  ...
  ops will possibly create conflicts of device assignment.
  "
  [ & {:keys [num_gpus_per_worker]} ]
   (py/call-attr-kw distribute "ParameterServerStrategy" [] {:num_gpus_per_worker num_gpus_per_worker }))
