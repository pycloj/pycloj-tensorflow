(ns tensorflow.contrib.distribute.MultiWorkerAllReduce
...
(defn MultiWorkerAllReduce 
  "All-reduce algorithms for distributed TensorFlow."
  [worker_devices num_gpus_per_worker  & {:keys [all_reduce_spec num_packs agg_small_grads_max_bytes agg_small_grads_max_group]} ]
    (py/call-attr-kw distribute "MultiWorkerAllReduce" [worker_devices num_gpus_per_worker] {:all_reduce_spec all_reduce_spec :num_packs num_packs :agg_small_grads_max_bytes agg_small_grads_max_bytes :agg_small_grads_max_group agg_small_grads_max_group }))
