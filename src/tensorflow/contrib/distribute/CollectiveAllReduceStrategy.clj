(ns tensorflow.contrib.distribute.CollectiveAllReduceStrategy
...
(defn CollectiveAllReduceStrategy 
  "Distribution strategy that uses collective ops for all-reduce.
  ...
  *** contrib version ***
  ...
  distributed environment.
  "
  [ & {:keys [num_gpus_per_worker communication]} ]
   (py/call-attr-kw distribute "CollectiveAllReduceStrategy" [] {:num_gpus_per_worker num_gpus_per_worker :communication communication }))
