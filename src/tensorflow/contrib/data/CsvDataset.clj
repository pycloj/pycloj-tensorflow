(ns tensorflow.contrib.data.CsvDataset
...
(defn CsvDataset 
  ...
  [filenames record_defaults compression_type buffer_size & {:keys [header field_delim use_quote_delim na_value select_cols]
                       :or {select_cols None}} ]
    (py/call-attr-kw data "CsvDataset" [filenames record_defaults compression_type buffer_size] {:header header :field_delim field_delim :use_quote_delim use_quote_delim :na_value na_value :select_cols select_cols }))
