(ns tensorflow.contrib.framework.convolutional-orthogonal-1d
...
(defn convolutional-orthogonal-1d 
  "Initializer that generates a 1D orthogonal kernel for ConvNets.
  ...
  [ & {:keys [gain seed dtype]
   ...
   (py/call-attr-kw framework "convolutional_orthogonal_1d" [] {:gain gain :seed seed :dtype dtype }))
