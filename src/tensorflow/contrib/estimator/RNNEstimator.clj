(ns tensorflow.contrib.estimator.RNNEstimator
...
(defn RNNEstimator 
  ...
  * for each `column` in `context_feature_columns`:
  ...
  @end_compatibility
  "
  [head sequence_feature_columns context_feature_columns num_units & {:keys [cell_type rnn_cell_fn return_sequences model_dir optimizer input_layer_partitioner config]
                       :or {rnn_cell_fn None model_dir None input_layer_partitioner None config None}} ]
    (py/call-attr-kw estimator "RNNEstimator" [head sequence_feature_columns context_feature_columns num_units] {:cell_type cell_type :rnn_cell_fn rnn_cell_fn :return_sequences return_sequences :model_dir model_dir :optimizer optimizer :input_layer_partitioner input_layer_partitioner :config config }))
