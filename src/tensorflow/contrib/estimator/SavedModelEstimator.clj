(ns tensorflow.contrib.estimator.SavedModelEstimator
...
(defn SavedModelEstimator 
  ...
  **Step 3: Create a SavedModelEstimator from the exported SavedModel.**
  ...
  (py/call-attr estimator "SavedModelEstimator"  saved_model_dir model_dir ))
...
(defn export-savedmodel 
  ""
  [ self ]
    (py/call-attr self "export_savedmodel"))
