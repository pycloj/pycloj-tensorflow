(ns tensorflow.contrib.estimator.RNNClassifier
...
(defn RNNClassifier 
  ...
  * for each `column` in `context_feature_columns`:
  ...
  @end_compatibility
  "
  [sequence_feature_columns context_feature_columns num_units & {:keys [cell_type rnn_cell_fn model_dir n_classes weight_column label_vocabulary optimizer loss_reduction input_layer_partitioner config]
                       :or {rnn_cell_fn None model_dir None weight_column None label_vocabulary None input_layer_partitioner None config None}} ]
    (py/call-attr-kw estimator "RNNClassifier" [sequence_feature_columns context_feature_columns num_units] {:cell_type cell_type :rnn_cell_fn rnn_cell_fn :model_dir model_dir :n_classes n_classes :weight_column weight_column :label_vocabulary label_vocabulary :optimizer optimizer :loss_reduction loss_reduction :input_layer_partitioner input_layer_partitioner :config config }))
