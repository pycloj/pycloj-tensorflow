(ns tensorflow.contrib.checkpoint.CheckpointManager
...
(defn CheckpointManager 
  ...
  [checkpoint directory max_to_keep keep_checkpoint_every_n_hours  & {:keys [checkpoint_name]} ]
    (py/call-attr-kw checkpoint "CheckpointManager" [checkpoint directory max_to_keep keep_checkpoint_every_n_hours] {:checkpoint_name checkpoint_name }))
