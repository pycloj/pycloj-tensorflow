(ns tensorflow.contrib.tpu.AsyncCheckpointSaverHook
...
(defn AsyncCheckpointSaverHook 
  "Saves checkpoints every N steps or seconds."
  [checkpoint_dir save_secs save_steps saver & {:keys [checkpoint_basename scaffold listeners]
                       :or {scaffold None listeners None}} ]
    (py/call-attr-kw tpu "AsyncCheckpointSaverHook" [checkpoint_dir save_secs save_steps saver] {:checkpoint_basename checkpoint_basename :scaffold scaffold :listeners listeners }))
