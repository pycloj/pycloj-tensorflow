(ns tensorflow.contrib.tensor-forest.python.ops.tensor-forest-ops
...
(py/initialize!)
(defonce tensor-forest-ops (import-module "tensorflow.contrib.tensor_forest.python.ops.tensor_forest_ops"))
...
(defn ReinterpretStringToFloat 
  ...
  "
  [ input_data name ]
  (py/call-attr tensor-forest-ops "ReinterpretStringToFloat"  input_data name ))
...
(defn ScatterAddNdim 
  ...
  (py/call-attr tensor-forest-ops "ScatterAddNdim"  input indices deltas name ))
...
(defn deprecated-endpoints 
  ...
  "
  [  ]
  (py/call-attr tensor-forest-ops "deprecated_endpoints"  ))
...
(defn reinterpret-string-to-float 
  ...
  "
  [ input_data name ]
  (py/call-attr tensor-forest-ops "reinterpret_string_to_float"  input_data name ))
...
(defn reinterpret-string-to-float-eager-fallback 
  ...
  "
  [ input_data name ctx ]
  (py/call-attr tensor-forest-ops "reinterpret_string_to_float_eager_fallback"  input_data name ctx ))
...
(defn scatter-add-ndim 
  ...
  "
  [ input indices deltas name ]
  (py/call-attr tensor-forest-ops "scatter_add_ndim"  input indices deltas name ))

(defn scatter-add-ndim-eager-fallback 
  ""
  [ input indices deltas name ctx ]
  (py/call-attr tensor-forest-ops "scatter_add_ndim_eager_fallback"  input indices deltas name ctx ))
