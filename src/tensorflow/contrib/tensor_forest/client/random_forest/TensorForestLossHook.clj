(ns tensorflow.contrib.tensor-forest.client.random-forest.TensorForestLossHook
...
(defn TensorForestLossHook 
  "Monitor to request stop when loss stops decreasing."
  [ early_stopping_rounds early_stopping_loss_threshold loss_op ]
  (py/call-attr random-forest "TensorForestLossHook"  early_stopping_rounds early_stopping_loss_threshold loss_op ))
