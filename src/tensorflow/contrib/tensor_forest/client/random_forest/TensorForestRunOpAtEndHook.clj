(ns tensorflow.contrib.tensor-forest.client.random-forest.TensorForestRunOpAtEndHook
  ""
...
(defn TensorForestRunOpAtEndHook 
  ""
  [ op_dict ]
  (py/call-attr random-forest "TensorForestRunOpAtEndHook"  op_dict ))
