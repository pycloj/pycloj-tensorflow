(ns tensorflow.contrib.tensor-forest.client.random-forest.MultiForestMultiHeadEstimator
...
(defn MultiForestMultiHeadEstimator 
  "An estimator that can train a forest for a multi-headed problems.
  ...
  be used to train separate forests for each output.
  "
  [params_list device_assigner model_dir feature_columns & {:keys [graph_builder_class config weight_column keys_column feature_engineering_fn early_stopping_rounds num_trainers trainer_id report_feature_importances local_eval]
                       :or {config None weight_column None keys_column None feature_engineering_fn None}} ]
    (py/call-attr-kw random-forest "MultiForestMultiHeadEstimator" [params_list device_assigner model_dir feature_columns] {:graph_builder_class graph_builder_class :config config :weight_column weight_column :keys_column keys_column :feature_engineering_fn feature_engineering_fn :early_stopping_rounds early_stopping_rounds :num_trainers num_trainers :trainer_id trainer_id :report_feature_importances report_feature_importances :local_eval local_eval }))
