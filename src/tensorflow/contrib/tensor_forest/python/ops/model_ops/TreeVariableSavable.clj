(ns tensorflow.contrib.tensor-forest.python.ops.model-ops.TreeVariableSavable
...
(defn TreeVariableSavable 
  "SaveableObject implementation for TreeVariable."
  [ params tree_handle stats_handle create_op name ]
  (py/call-attr model-ops "TreeVariableSavable"  params tree_handle stats_handle create_op name ))
