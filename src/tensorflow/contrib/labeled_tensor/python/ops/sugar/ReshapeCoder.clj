(ns tensorflow.contrib.labeled-tensor.python.ops.sugar.ReshapeCoder
...
(py/initialize!)
(defonce sugar (import-module "tensorflow.contrib.labeled_tensor.python.ops.sugar"))
...
(defn ReshapeCoder 
  ...
  (py/call-attr sugar "ReshapeCoder"  existing_axis_names new_axes name ))
