(ns tensorflow.contrib.opt.PowerSignOptimizer
...
(defn PowerSignOptimizer 
  "Optimizer that implements the PowerSign update.

  See [Bello et al., ICML2017],
  [Neural Optimizer Search with RL](https://arxiv.org/abs/1709.07417).
  "
  [ & {:keys [learning_rate base beta sign_decay_fn use_locking name]
       :or {sign_decay_fn None}} ]
  
   (py/call-attr-kw opt "PowerSignOptimizer" [] {:learning_rate learning_rate :base base :beta beta :sign_decay_fn sign_decay_fn :use_locking use_locking :name name }))
