(ns tensorflow.contrib.opt.GGTOptimizer
...
(defn GGTOptimizer 
  ...
  see [[ABCHSZZ 2018]](https://arxiv.org/pdf/1806.02958.pdf).
  "
  [ & {:keys [learning_rate beta1 use_locking name window eps svd_eps sigma_eps]} ]
   (py/call-attr-kw opt "GGTOptimizer" [] {:learning_rate learning_rate :beta1 beta1 :use_locking use_locking :name name :window window :eps eps :svd_eps svd_eps :sigma_eps sigma_eps }))
