(ns tensorflow.contrib.opt.ShampooOptimizer
...
(defn ShampooOptimizer 
  ...
  a lambda function that depends on step.
  "
  [ & {:keys [global_step max_matrix_size gbar_decay gbar_weight mat_gbar_decay mat_gbar_weight learning_rate svd_interval precond_update_interval epsilon alpha use_iterative_root use_locking name]} ]
   (py/call-attr-kw opt "ShampooOptimizer" [] {:global_step global_step :max_matrix_size max_matrix_size :gbar_decay gbar_decay :gbar_weight gbar_weight :mat_gbar_decay mat_gbar_decay :mat_gbar_weight mat_gbar_weight :learning_rate learning_rate :svd_interval svd_interval :precond_update_interval precond_update_interval :epsilon epsilon :alpha alpha :use_iterative_root use_iterative_root :use_locking use_locking :name name }))
