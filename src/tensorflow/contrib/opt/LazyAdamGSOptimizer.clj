(ns tensorflow.contrib.opt.LazyAdamGSOptimizer
...
(defn LazyAdamGSOptimizer 
  ...
  may lead to different empirical results.
  "
  [ & {:keys [global_step learning_rate beta1 beta2 epsilon use_locking name]} ]
   (py/call-attr-kw opt "LazyAdamGSOptimizer" [] {:global_step global_step :learning_rate learning_rate :beta1 beta1 :beta2 beta2 :epsilon epsilon :use_locking use_locking :name name }))
