(ns tensorflow.contrib.opt.AddSignOptimizer
...
(defn AddSignOptimizer 
  "Optimizer that implements the AddSign update.

  See [Bello et al., ICML2017],
  [Neural Optimizer Search with RL](https://arxiv.org/abs/1709.07417).
  "
  [ & {:keys [learning_rate alpha beta sign_decay_fn use_locking name]
       :or {sign_decay_fn None}} ]
  
   (py/call-attr-kw opt "AddSignOptimizer" [] {:learning_rate learning_rate :alpha alpha :beta beta :sign_decay_fn sign_decay_fn :use_locking use_locking :name name }))
