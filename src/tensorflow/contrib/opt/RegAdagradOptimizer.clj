(ns tensorflow.contrib.opt.RegAdagradOptimizer
...
(defn RegAdagradOptimizer 
  ...
  [learning_rate  & {:keys [initial_accumulator_value use_locking name]} ]
    (py/call-attr-kw opt "RegAdagradOptimizer" [learning_rate] {:initial_accumulator_value initial_accumulator_value :use_locking use_locking :name name }))
...
(defn avoid-updating-slots 
  ""
  [ self  ]
  (py/call-attr self "avoid_updating_slots"  self  ))
