(ns tensorflow.contrib.opt.LazyAdamOptimizer
...
(defn LazyAdamOptimizer 
  ...
  [ & {:keys [learning_rate beta1 beta2 epsilon use_locking name]} ]
   (py/call-attr-kw opt "LazyAdamOptimizer" [] {:learning_rate learning_rate :beta1 beta1 :beta2 beta2 :epsilon epsilon :use_locking use_locking :name name }))
