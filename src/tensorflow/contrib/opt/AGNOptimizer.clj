(ns tensorflow.contrib.opt.AGNOptimizer
...
(defn AGNOptimizer 
  ...
  Reference:
    ...
    https://arxiv.org/abs/1710.02368
  "
  [optimizer num_worker custom_getter  & {:keys [communication_period use_locking name]} ]
    (py/call-attr-kw opt "AGNOptimizer" [optimizer num_worker custom_getter] {:communication_period communication_period :use_locking use_locking :name name }))
