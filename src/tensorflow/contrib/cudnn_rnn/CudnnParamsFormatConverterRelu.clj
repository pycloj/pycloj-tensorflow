(ns tensorflow.contrib.cudnn-rnn.CudnnParamsFormatConverterRelu
...
(defn CudnnParamsFormatConverterRelu 
  "Helper class that converts between params of Cudnn and TF Relu RNN."
  [num_layers num_units input_size num_proj  & {:keys [input_mode direction]} ]
    (py/call-attr-kw cudnn-rnn "CudnnParamsFormatConverterRelu" [num_layers num_units input_size num_proj] {:input_mode input_mode :direction direction }))
