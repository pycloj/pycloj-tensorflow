(ns tensorflow.contrib.cudnn-rnn.CudnnCompatibleGRUCell
...
(defn CudnnCompatibleGRUCell 
  ...
  ```
  "
  [ num_units reuse kernel_initializer ]
  (py/call-attr cudnn-rnn "CudnnCompatibleGRUCell"  num_units reuse kernel_initializer ))
