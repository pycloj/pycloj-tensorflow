(ns tensorflow.contrib.cudnn-rnn.CudnnRNNTanhSaveable
  ""
...
(defn CudnnRNNTanhSaveable 
  ""
  [opaque_params num_layers num_units input_size & {:keys [input_mode direction scope name]
                       :or {scope None}} ]
    (py/call-attr-kw cudnn-rnn "CudnnRNNTanhSaveable" [opaque_params num_layers num_units input_size] {:input_mode input_mode :direction direction :scope scope :name name }))
