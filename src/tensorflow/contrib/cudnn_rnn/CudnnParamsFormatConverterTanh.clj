(ns tensorflow.contrib.cudnn-rnn.CudnnParamsFormatConverterTanh
...
(defn CudnnParamsFormatConverterTanh 
  "Helper class that converts between params of Cudnn and TF Tanh RNN."
  [num_layers num_units input_size num_proj  & {:keys [input_mode direction]} ]
    (py/call-attr-kw cudnn-rnn "CudnnParamsFormatConverterTanh" [num_layers num_units input_size num_proj] {:input_mode input_mode :direction direction }))
