...
(defn TensorArray 
  ...
  [dtype size dynamic_size clear_after_read tensor_array_name handle flow & {:keys [infer_shape element_shape colocate_with_first_write_call name]
    ...
    (py/call-attr-kw tensorflow "TensorArray" [dtype size dynamic_size clear_after_read tensor_array_name handle flow] {:infer_shape infer_shape :element_shape element_shape :colocate_with_first_write_call colocate_with_first_write_call :name name }))
