(ns tensorflow.layers.Conv3DTranspose
...
(defn Conv3DTranspose 
  ...
  Arguments:
    ...
    name: A string, the name of the layer.
  "
  [filters kernel_size & {:keys [strides padding data_format activation use_bias kernel_initializer bias_initializer kernel_regularizer bias_regularizer activity_regularizer kernel_constraint bias_constraint trainable name]
