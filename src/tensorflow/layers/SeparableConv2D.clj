(ns tensorflow.layers.SeparableConv2D
...
(py/initialize!)
(defonce layers (import-module "tensorflow.layers"))

(defn SeparableConv2D 
  "Depthwise separable 2D convolution.
  ...
  Arguments:
    ...
    name: A string, the name of the layer.
  "
  [filters kernel_size & {:keys [strides padding data_format dilation_rate depth_multiplier activation use_bias depthwise_initializer pointwise_initializer bias_initializer depthwise_regularizer pointwise_regularizer bias_regularizer activity_regularizer depthwise_constraint pointwise_constraint bias_constraint trainable name]
                       :or {activation None depthwise_initializer None pointwise_initializer None depthwise_regularizer None pointwise_regularizer None bias_regularizer None activity_regularizer None depthwise_constraint None pointwise_constraint None bias_constraint None name None}} ]
    (py/call-attr-kw layers "SeparableConv2D" [filters kernel_size] {:strides strides :padding padding :data_format data_format :dilation_rate dilation_rate :depth_multiplier depth_multiplier :activation activation :use_bias use_bias :depthwise_initializer depthwise_initializer :pointwise_initializer pointwise_initializer :bias_initializer bias_initializer :depthwise_regularizer depthwise_regularizer :pointwise_regularizer pointwise_regularizer :bias_regularizer bias_regularizer :activity_regularizer activity_regularizer :depthwise_constraint depthwise_constraint :pointwise_constraint pointwise_constraint :bias_constraint bias_constraint :trainable trainable :name name }))
