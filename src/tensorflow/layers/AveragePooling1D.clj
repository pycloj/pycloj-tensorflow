(ns tensorflow.layers.AveragePooling1D
...
(defn AveragePooling1D 
  ...
  [pool_size strides & {:keys [padding data_format name]
                       :or {name None}} ]
    (py/call-attr-kw layers "AveragePooling1D" [pool_size strides] {:padding padding :data_format data_format :name name }))
