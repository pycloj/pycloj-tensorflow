...
(defn Dense 
  ...
  Properties:
    ...
    bias: Bias vector, if applicable (TensorFlow variable or tensor).
  "
  [units activation & {:keys [use_bias kernel_initializer bias_initializer kernel_regularizer bias_regularizer activity_regularizer kernel_constraint bias_constraint trainable name]
                       :or {kernel_initializer None kernel_regularizer None bias_regularizer None activity_regularizer None kernel_constraint None bias_constraint None name None}} ]
    (py/call-attr-kw layers "Dense" [units activation] {:use_bias use_bias :kernel_initializer kernel_initializer :bias_initializer bias_initializer :kernel_regularizer kernel_regularizer :bias_regularizer bias_regularizer :activity_regularizer activity_regularizer :kernel_constraint kernel_constraint :bias_constraint bias_constraint :trainable trainable :name name }))
