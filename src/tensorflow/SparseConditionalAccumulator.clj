(ns tensorflow.SparseConditionalAccumulator
...
(defn SparseConditionalAccumulator 
  ...
  [dtype shape shared_name  & {:keys [name reduction_type]} ]
    (py/call-attr-kw tensorflow "SparseConditionalAccumulator" [dtype shape shared_name] {:name name :reduction_type reduction_type }))
