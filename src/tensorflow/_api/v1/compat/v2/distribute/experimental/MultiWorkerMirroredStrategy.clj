(ns tensorflow.-api.v1.compat.v2.distribute.experimental.MultiWorkerMirroredStrategy
...
(defn MultiWorkerMirroredStrategy 
  "A distribution strategy for synchronous training on multiple workers.
  ...
  "
  [ & {:keys [communication]} ]
   (py/call-attr-kw experimental "MultiWorkerMirroredStrategy" [] {:communication communication }))
