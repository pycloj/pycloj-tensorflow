(ns tensorflow.-api.v1.compat.v2.distribute.experimental.TPUStrategy
...
(defn TPUStrategy 
  "TPU distribution strategy implementation."
  [ tpu_cluster_resolver device_assignment ]
  (py/call-attr experimental "TPUStrategy"  tpu_cluster_resolver device_assignment ))
