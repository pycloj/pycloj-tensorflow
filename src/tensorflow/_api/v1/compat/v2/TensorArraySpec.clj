(ns tensorflow.-api.v1.compat.v2.TensorArraySpec
...
(defn TensorArraySpec 
  ...
  [element_shape  & {:keys [dtype dynamic_size infer_shape]} ]
    (py/call-attr-kw v2 "TensorArraySpec" [element_shape] {:dtype dtype :dynamic_size dynamic_size :infer_shape infer_shape }))
