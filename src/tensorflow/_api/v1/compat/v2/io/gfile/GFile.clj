(ns tensorflow.-api.v1.compat.v2.io.gfile.GFile
...
(py/initialize!)
(defonce gfile (import-module "tensorflow._api.v1.compat.v2.io.gfile"))
(defn GFile 
  "File I/O wrappers without thread locking.
  ...
  "
  [name  & {:keys [mode]} ]
    (py/call-attr-kw gfile "GFile" [name] {:mode mode }))
