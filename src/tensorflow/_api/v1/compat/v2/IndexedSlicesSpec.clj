(ns tensorflow.-api.v1.compat.v2.IndexedSlicesSpec
...
(defn IndexedSlicesSpec 
  ...
  [shape & {:keys [dtype indices_dtype dense_shape_dtype indices_shape]
    ...
    (py/call-attr-kw v2 "IndexedSlicesSpec" [shape] {:dtype dtype :indices_dtype indices_dtype :dense_shape_dtype dense_shape_dtype :indices_shape indices_shape }))
