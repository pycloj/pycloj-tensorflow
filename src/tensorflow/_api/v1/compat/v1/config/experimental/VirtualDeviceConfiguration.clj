(ns tensorflow.-api.v1.compat.v1.config.experimental.VirtualDeviceConfiguration
...
(py/initialize!)
(defonce experimental (import-module "tensorflow._api.v1.compat.v1.config.experimental"))
