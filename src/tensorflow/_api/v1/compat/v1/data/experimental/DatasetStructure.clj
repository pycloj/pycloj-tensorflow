(ns tensorflow.-api.v1.compat.v1.data.experimental.DatasetStructure
...
(defn DatasetStructure 
  "Type specification for `tf.data.Dataset`."
  [element_spec  & {:keys [dataset_shape]} ]
    (py/call-attr-kw experimental "DatasetStructure" [element_spec] {:dataset_shape dataset_shape }))
