(ns tensorflow.-api.v1.compat.v1.data.FixedLengthRecordDataset
...
(defn FixedLengthRecordDataset 
  "A `Dataset` of fixed-length records from one or more binary files."
  [ filenames record_bytes header_bytes footer_bytes buffer_size compression_type num_parallel_reads ]
  (py/call-attr data "FixedLengthRecordDataset"  filenames record_bytes header_bytes footer_bytes buffer_size compression_type num_parallel_reads ))
...
(defn filter-with-legacy-function 
...
Returns:
  Dataset: The `Dataset` containing the elements of this dataset for which
      `predicate` is `True`."
  [ self predicate ]
  (py/call-attr self "filter_with_legacy_function"  self predicate ))
...
(defn from-sparse-tensor-slices 
...
Returns:
  ...
  [ self sparse_tensor ]
  (py/call-attr self "from_sparse_tensor_slices"  self sparse_tensor ))
...
Raises:
  ...
  [ self shared_name ]
  (py/call-attr self "make_initializable_iterator"  self shared_name ))
...
Returns:
  An `Iterator` over the elements of this dataset."
  [ self  ]
  (py/call-attr self "make_one_shot_iterator"  self  ))
...
Returns:
  Dataset: A `Dataset`."
  [ self map_func num_parallel_calls ]
  (py/call-attr self "map_with_legacy_function"  self map_func num_parallel_calls ))
