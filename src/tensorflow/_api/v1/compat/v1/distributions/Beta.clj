(ns tensorflow.-api.v1.compat.v1.distributions.Beta
  "Beta distribution.
...
(defn Beta 
  ...
  * `Gamma` is the [gamma function](
  ...
  [concentration1 concentration0  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "Beta" [concentration1 concentration0] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
