(ns tensorflow.-api.v1.compat.v1.distributions.DirichletMultinomial
...
(defn DirichletMultinomial 
  ...
  * `Gamma` is the [gamma function](
  ...
  "
  [total_count concentration  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "DirichletMultinomial" [total_count concentration] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
