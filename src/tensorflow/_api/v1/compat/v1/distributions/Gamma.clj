(ns tensorflow.-api.v1.compat.v1.distributions.Gamma
  "Gamma distribution.
...
(defn Gamma 
  ...
  * `Gamma` is the [gamma function](
  ...
  [concentration rate  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "Gamma" [concentration rate] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
