(ns tensorflow.-api.v1.compat.v1.distributions.Categorical
...
(defn Categorical 
  ...
  [logits probs  & {:keys [dtype validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "Categorical" [logits probs] {:dtype dtype :validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
