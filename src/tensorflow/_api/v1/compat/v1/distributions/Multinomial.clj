(ns tensorflow.-api.v1.compat.v1.distributions.Multinomial
...
(defn Multinomial 
  ...
  * `N!` denotes `N` factorial.
  ...
  [total_count logits probs  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "Multinomial" [total_count logits probs] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
