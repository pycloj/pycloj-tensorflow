(ns tensorflow.-api.v1.compat.v1.distributions.Exponential
...
(defn Exponential 
  ...
  [rate  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "Exponential" [rate] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
