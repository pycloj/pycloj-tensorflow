(ns tensorflow.-api.v1.compat.v1.distributions.Laplace
...
(defn Laplace 
  ...
  [loc scale  & {:keys [validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "Laplace" [loc scale] {:validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
