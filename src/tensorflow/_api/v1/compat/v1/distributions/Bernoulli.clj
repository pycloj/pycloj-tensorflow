(ns tensorflow.-api.v1.compat.v1.distributions.Bernoulli
...
(defn Bernoulli 
  ...
  [logits probs  & {:keys [dtype validate_args allow_nan_stats name]} ]
    (py/call-attr-kw distributions "Bernoulli" [logits probs] {:dtype dtype :validate_args validate_args :allow_nan_stats allow_nan_stats :name name }))
