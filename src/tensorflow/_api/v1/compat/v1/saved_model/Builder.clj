(ns tensorflow.-api.v1.compat.v1.saved-model.Builder
...
(py/initialize!)
(defonce saved-model (import-module "tensorflow._api.v1.compat.v1.saved_model"))
...
(defn Builder 
  ...
  "
  [ export_dir ]
  (py/call-attr saved-model "Builder"  export_dir ))
