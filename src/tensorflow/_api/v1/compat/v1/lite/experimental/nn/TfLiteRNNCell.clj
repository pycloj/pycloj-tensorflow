(ns tensorflow.-api.v1.compat.v1.lite.experimental.nn.TfLiteRNNCell
...
(defn TfLiteRNNCell 
  ...
  variables in the desired for the tflite ops.
  "
  [ num_units activation reuse name dtype ]
  (py/call-attr nn "TfLiteRNNCell"  num_units activation reuse name dtype ))
