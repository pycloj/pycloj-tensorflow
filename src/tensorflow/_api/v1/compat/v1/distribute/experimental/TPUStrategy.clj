(ns tensorflow.-api.v1.compat.v1.distribute.experimental.TPUStrategy
...
(defn TPUStrategy 
  "TPU distribution strategy implementation."
  [ tpu_cluster_resolver steps_per_run device_assignment ]
  (py/call-attr experimental "TPUStrategy"  tpu_cluster_resolver steps_per_run device_assignment ))
...
(defn steps-per-run 
  ...
  [ self ]
    (py/call-attr self "steps_per_run"))
