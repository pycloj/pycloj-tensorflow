(ns tensorflow.-api.v1.compat.v1.distribute.cluster-resolver.KubernetesClusterResolver
...
(py/initialize!)
(defonce cluster-resolver (import-module "tensorflow._api.v1.compat.v1.distribute.cluster_resolver"))
