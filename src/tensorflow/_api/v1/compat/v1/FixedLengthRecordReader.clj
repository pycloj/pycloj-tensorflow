(ns tensorflow.-api.v1.compat.v1.FixedLengthRecordReader
...
(defn FixedLengthRecordReader 
  ...
  @end_compatibility
  "
  [ record_bytes header_bytes footer_bytes hop_bytes name encoding ]
  (py/call-attr v1 "FixedLengthRecordReader"  record_bytes header_bytes footer_bytes hop_bytes name encoding ))
