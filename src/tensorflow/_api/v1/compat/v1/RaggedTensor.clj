(ns tensorflow.-api.v1.compat.v1.RaggedTensor
...
(defn RaggedTensor 
  ...
  *ragged-rank*.  A `RaggedTensor`'s ragged-rank is fixed at graph creation
  ...
  [values row_splits cached_row_lengths cached_value_rowids cached_nrows  & {:keys [internal]} ]
    (py/call-attr-kw v1 "RaggedTensor" [values row_splits cached_row_lengths cached_value_rowids cached_nrows] {:internal internal }))
