(ns tensorflow.-api.v1.compat.v1.RandomShuffleQueue
...
(defn RandomShuffleQueue 
  ...
  [capacity min_after_dequeue dtypes shapes names seed shared_name  & {:keys [name]} ]
    (py/call-attr-kw v1 "RandomShuffleQueue" [capacity min_after_dequeue dtypes shapes names seed shared_name] {:name name }))
