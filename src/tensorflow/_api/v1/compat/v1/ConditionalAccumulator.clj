(ns tensorflow.-api.v1.compat.v1.ConditionalAccumulator
...
(defn ConditionalAccumulator 
  ...
  [dtype shape shared_name  & {:keys [name reduction_type]} ]
    (py/call-attr-kw v1 "ConditionalAccumulator" [dtype shape shared_name] {:name name :reduction_type reduction_type }))
