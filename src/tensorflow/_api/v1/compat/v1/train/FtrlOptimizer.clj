(ns tensorflow.-api.v1.compat.v1.train.FtrlOptimizer
...
(defn FtrlOptimizer 
  ...
  loss function).
  "
  [learning_rate & {:keys [learning_rate_power initial_accumulator_value l1_regularization_strength l2_regularization_strength use_locking name accum_name linear_name l2_shrinkage_regularization_strength]
                       :or {accum_name None linear_name None}} ]
    (py/call-attr-kw train "FtrlOptimizer" [learning_rate] {:learning_rate_power learning_rate_power :initial_accumulator_value initial_accumulator_value :l1_regularization_strength l1_regularization_strength :l2_regularization_strength l2_regularization_strength :use_locking use_locking :name name :accum_name accum_name :linear_name linear_name :l2_shrinkage_regularization_strength l2_shrinkage_regularization_strength }))
