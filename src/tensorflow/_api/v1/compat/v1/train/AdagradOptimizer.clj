(ns tensorflow.-api.v1.compat.v1.train.AdagradOptimizer
...
(defn AdagradOptimizer 
  ...
  [learning_rate  & {:keys [initial_accumulator_value use_locking name]} ]
    (py/call-attr-kw train "AdagradOptimizer" [learning_rate] {:initial_accumulator_value initial_accumulator_value :use_locking use_locking :name name }))
