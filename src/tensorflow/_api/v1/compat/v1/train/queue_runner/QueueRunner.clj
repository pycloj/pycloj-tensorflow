(ns tensorflow.-api.v1.compat.v1.train.queue-runner.QueueRunner
...
(py/initialize!)
(defonce queue-runner (import-module "tensorflow._api.v1.compat.v1.train.queue_runner"))
...
(defn QueueRunner 
  ...
  (py/call-attr queue-runner "QueueRunner"  queue enqueue_ops close_op cancel_op queue_closed_exception_types queue_runner_def import_scope ))
