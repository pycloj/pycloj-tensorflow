(ns tensorflow.-api.v1.compat.v1.train.AdamOptimizer
...
(defn AdamOptimizer 
  ...
  [ & {:keys [learning_rate beta1 beta2 epsilon use_locking name]} ]
   (py/call-attr-kw train "AdamOptimizer" [] {:learning_rate learning_rate :beta1 beta1 :beta2 beta2 :epsilon epsilon :use_locking use_locking :name name }))
