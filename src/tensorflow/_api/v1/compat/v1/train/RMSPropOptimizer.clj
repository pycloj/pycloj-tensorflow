(ns tensorflow.-api.v1.compat.v1.train.RMSPropOptimizer
...
(defn RMSPropOptimizer 
  ...
  [learning_rate  & {:keys [decay momentum epsilon use_locking centered name]} ]
    (py/call-attr-kw train "RMSPropOptimizer" [learning_rate] {:decay decay :momentum momentum :epsilon epsilon :use_locking use_locking :centered centered :name name }))
