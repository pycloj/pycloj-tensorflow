(ns tensorflow.-api.v1.compat.v1.train.ProximalGradientDescentOptimizer
...
(defn ProximalGradientDescentOptimizer 
  "Optimizer that implements the proximal gradient descent algorithm.

  See this [paper](http://papers.nips.cc/paper/3793-efficient-learning-using-forward-backward-splitting.pdf).
  "
  [learning_rate  & {:keys [l1_regularization_strength l2_regularization_strength use_locking name]} ]
    (py/call-attr-kw train "ProximalGradientDescentOptimizer" [learning_rate] {:l1_regularization_strength l1_regularization_strength :l2_regularization_strength l2_regularization_strength :use_locking use_locking :name name }))
