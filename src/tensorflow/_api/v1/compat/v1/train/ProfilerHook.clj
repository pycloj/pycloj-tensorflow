(ns tensorflow.-api.v1.compat.v1.train.ProfilerHook
...
(defn ProfilerHook 
  ...
  [save_steps save_secs  & {:keys [output_dir show_dataflow show_memory]} ]
    (py/call-attr-kw train "ProfilerHook" [save_steps save_secs] {:output_dir output_dir :show_dataflow show_dataflow :show_memory show_memory }))
