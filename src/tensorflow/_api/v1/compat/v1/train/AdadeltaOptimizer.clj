(ns tensorflow.-api.v1.compat.v1.train.AdadeltaOptimizer
...
(defn AdadeltaOptimizer 
  ...
  [ & {:keys [learning_rate rho epsilon use_locking name]} ]
   (py/call-attr-kw train "AdadeltaOptimizer" [] {:learning_rate learning_rate :rho rho :epsilon epsilon :use_locking use_locking :name name }))
