(ns tensorflow.-api.v1.compat.v1.train.MomentumOptimizer
...
(defn MomentumOptimizer 
  ...
  [learning_rate momentum  & {:keys [use_locking name use_nesterov]} ]
    (py/call-attr-kw train "MomentumOptimizer" [learning_rate momentum] {:use_locking use_locking :name name :use_nesterov use_nesterov }))
