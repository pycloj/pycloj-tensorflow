(ns tensorflow.-api.v1.compat.v1.train.ProximalAdagradOptimizer
...
(defn ProximalAdagradOptimizer 
  "Optimizer that implements the Proximal Adagrad algorithm.

  See this [paper](http://papers.nips.cc/paper/3793-efficient-learning-using-forward-backward-splitting.pdf).
  "
  [learning_rate  & {:keys [initial_accumulator_value l1_regularization_strength l2_regularization_strength use_locking name]} ]
    (py/call-attr-kw train "ProximalAdagradOptimizer" [learning_rate] {:initial_accumulator_value initial_accumulator_value :l1_regularization_strength l1_regularization_strength :l2_regularization_strength l2_regularization_strength :use_locking use_locking :name name }))
