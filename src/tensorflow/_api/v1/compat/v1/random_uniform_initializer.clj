(ns tensorflow.-api.v1.compat.v1.random-uniform-initializer
...
(defn random-uniform-initializer 
  ...
  [ & {:keys [minval maxval seed dtype]
   ...
   (py/call-attr-kw v1 "random_uniform_initializer" [] {:minval minval :maxval maxval :seed seed :dtype dtype }))
