(ns tensorflow.-api.v1.compat.v1.uniform-unit-scaling-initializer
...
(defn uniform-unit-scaling-initializer 
  "Initializer that generates tensors without scaling variance.
  ...
  [ & {:keys [factor seed dtype]
   ...
   (py/call-attr-kw v1 "uniform_unit_scaling_initializer" [] {:factor factor :seed seed :dtype dtype }))
