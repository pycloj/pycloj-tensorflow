(ns tensorflow.-api.v1.compat.v1.queue.PriorityQueue
...
(defn PriorityQueue 
  ...
  this class.
  "
  [capacity types shapes names shared_name  & {:keys [name]} ]
    (py/call-attr-kw queue "PriorityQueue" [capacity types shapes names shared_name] {:name name }))
