(ns tensorflow.-api.v1.compat.v1.queue.RandomShuffleQueue
...
(py/initialize!)
(defonce queue (import-module "tensorflow._api.v1.compat.v1.queue"))
(defn RandomShuffleQueue 
  ...
  this class.
  "
  [capacity min_after_dequeue dtypes shapes names seed shared_name  & {:keys [name]} ]
    (py/call-attr-kw queue "RandomShuffleQueue" [capacity min_after_dequeue dtypes shapes names seed shared_name] {:name name }))
