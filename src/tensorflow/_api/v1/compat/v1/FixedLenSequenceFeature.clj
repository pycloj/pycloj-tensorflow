(ns tensorflow.-api.v1.compat.v1.FixedLenSequenceFeature
...
(defn FixedLenSequenceFeature 
  ...
  [shape dtype & {:keys [allow_missing default_value]
    ...
    (py/call-attr-kw v1 "FixedLenSequenceFeature" [shape dtype] {:allow_missing allow_missing :default_value default_value }))
