(ns tensorflow.-api.v1.compat.v1.variable-scope
...
(defn variable-scope 
  ...
  [name_or_scope default_name values initializer regularizer caching_device partitioner custom_getter reuse dtype use_resource constraint  & {:keys [auxiliary_name_scope]} ]
    (py/call-attr-kw v1 "variable_scope" [name_or_scope default_name values initializer regularizer caching_device partitioner custom_getter reuse dtype use_resource constraint] {:auxiliary_name_scope auxiliary_name_scope }))
