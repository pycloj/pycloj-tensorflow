(ns tensorflow.-api.v1.compat.v1.nn.rnn-cell.BasicLSTMCell
...
(defn BasicLSTMCell 
  ...
  better performance on CPU.
  "
  [num_units & {:keys [forget_bias state_is_tuple activation reuse name dtype]
                       :or {activation None reuse None name None dtype None}} ]
    (py/call-attr-kw rnn-cell "BasicLSTMCell" [num_units] {:forget_bias forget_bias :state_is_tuple state_is_tuple :activation activation :reuse reuse :name name :dtype dtype }))
