(ns tensorflow.-api.v1.compat.v1.nn.rnn-cell.MultiRNNCell
...
(defn MultiRNNCell 
  ...
  ```
  "
  [cells  & {:keys [state_is_tuple]} ]
    (py/call-attr-kw rnn-cell "MultiRNNCell" [cells] {:state_is_tuple state_is_tuple }))
