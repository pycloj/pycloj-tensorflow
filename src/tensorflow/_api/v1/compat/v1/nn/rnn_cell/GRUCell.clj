(ns tensorflow.-api.v1.compat.v1.nn.rnn-cell.GRUCell
...
(defn GRUCell 
  ...
  Args:
    ...
    **kwargs: Dict, keyword named properties for common layer attributes, like
      `trainable` etc when constructing the cell from configs of get_config().
  "
  [ num_units activation reuse kernel_initializer bias_initializer name dtype ]
  (py/call-attr rnn-cell "GRUCell"  num_units activation reuse kernel_initializer bias_initializer name dtype ))
