(ns tensorflow.-api.v1.compat.v1.sparse.SparseConditionalAccumulator
...
(defn SparseConditionalAccumulator 
  ...
  [dtype shape shared_name  & {:keys [name reduction_type]} ]
    (py/call-attr-kw sparse "SparseConditionalAccumulator" [dtype shape shared_name] {:name name :reduction_type reduction_type }))
