(ns tensorflow.python.keras.api.-v1.keras.backend
  "Keras backend API.
...
(py/initialize!)
(defonce backend (import-module "tensorflow.python.keras.api._v1.keras.backend"))
...
(defn learning-phase-scope 
  ...
  "
  [ value ]
  (py/call-attr backend "learning_phase_scope"  value ))
...
(defn local-conv1d 
  ...
  "
  [ inputs kernel kernel_size strides data_format ]
  (py/call-attr backend "local_conv1d"  inputs kernel kernel_size strides data_format ))
...
(defn local-conv2d 
  ...
  (py/call-attr backend "local_conv2d"  inputs kernel kernel_size strides output_shape data_format ))
