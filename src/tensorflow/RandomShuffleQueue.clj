(ns tensorflow.RandomShuffleQueue
...
(defn RandomShuffleQueue 
  ...
  [capacity min_after_dequeue dtypes shapes names seed shared_name  & {:keys [name]} ]
    (py/call-attr-kw tensorflow "RandomShuffleQueue" [capacity min_after_dequeue dtypes shapes names seed shared_name] {:name name }))
